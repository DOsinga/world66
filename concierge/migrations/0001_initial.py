# Generated by Django 5.2.1 on 2026-05-27 17:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('contacting', 'Contacting'), ('negotiating', 'Negotiating'), ('agreed', 'Agreed'), ('failed', 'Failed')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='concierge.negotiationsession')),
            ],
            options={
                'ordering': ['timestamp'],
            },
