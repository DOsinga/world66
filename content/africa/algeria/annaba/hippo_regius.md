...
An on-site museum houses mosaics recovered from the excavations, portrait busts, and a small collection of inscriptions. Most visitors come for the Augustine connection, but the site is genuinely impressive independent of that — the scale of the forum and the quality of the mosaic work make clear how wealthy and cosmopolitan Hippo Regius was at its peak. The ruins are partially shaded and not heavily visited, which makes for a quiet and unhurried visit.
