...
The tower sits in the commercial heart of central Cotonou, near the Boulevard Saint-Michel, and it gives orientation to the city in a neighbourhood where everything else is low-rise. The surrounding streets are among the busiest in Cotonou — a constant flow of zem motorcycle taxis, market women with goods balanced on their heads, and traders from across the region. Even if the building itself is unremarkable inside, the area around it is vivid.
