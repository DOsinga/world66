---
title: "Orapa Game Management Area"
type: poi
tags:
  - things_to_do
  - sight
...
Access to the game management area does not require the same permit as entry to the town itself, and a 4WD vehicle is essential given the sandy track conditions. The area is remote and self-sufficient travel is for experienced bush travellers only. Most visitors who encounter Orapa's wildlife do so on organised safaris that use this region as a transit between the Central Kalahari Game Reserve to the south and the Makgadikgadi Pans to the north.
