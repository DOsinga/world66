...
The tower is primarily an office building and not open for general visits, but it is worth seeing from the outside for its architectural ambition and for what it represents: a petro-state's attempt to stamp modernity onto a city that was built for a very different scale. The view from across the Congo River, where Nabemba and the Kinshasa towers face each other, is one of the stranger urban panoramas in Central Africa.
