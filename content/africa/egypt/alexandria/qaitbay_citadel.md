...
The fort has three floors, a small mosque inside the keep, and a roof terrace with views over the harbour, the corniche, and the Mediterranean. A small **naval museum** inside the citadel covers Egyptian maritime history from the Pharaonic era to the modern navy. Allow 90 minutes for the visit. Reach by taxi or the corniche-running tram (route 1). The setting is most atmospheric at sunset, when the citadel's golden stone catches the late light.
