...
Dive operators in Naama Bay and Sharks Bay run day trips by fast boat; the crossing takes about ninety minutes each way and the price is correspondingly higher than for coral dives. The wreck site is exposed and currents can be strong — most operators require an advanced certificate and at least 50 logged dives.
