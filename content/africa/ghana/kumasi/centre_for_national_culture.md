...
type: poi
snippet: Crafts village, museum, and outdoor stage in central Kumasi
tags:
  - things_to_do
  - sight
  - crafts
...
The grounds also include the Okomfo Anokye library and an open-air auditorium where drumming and dance performances are staged on weekends — ask at the entrance for the week's schedule. Allow at least an hour, longer if you want to bargain seriously.
