---
title: Ditinn Falls (Chutes de Ditinn)
type: poi
tags:
  - things_to_do
  - sight
...
Visit during or just after the rainy season (July–October) when the volume of water is at its peak — in the dry season the falls reduce to a thinner curtain. The area around the base is lush and cool even when the plateau above bakes. Local guides in Dalaba can arrange transport and accompany you on the walk; going alone is not advised as the path is unmarked.
