...
The palace is technically not open to visitors in its interior, though the grounds can be accessed and the exterior provides the best architectural photography in the historic quarter. The peeling yellow paint and overgrown gardens have become part of the appeal rather than a problem to be solved; the building has a melancholy grandeur that is more affecting than any restoration could provide.

From the palace, you can see the full length of the peninsula: the Atlantic on one side, the Comoé lagoon on the other, and the colonial streetscape stretching back toward the entrance of the historic zone.
