...
The area below the escarpment, in the Mara Triangle (managed by the Mara Conservancy), tends to have less vehicle traffic than the central and eastern sections of the reserve. The views from the escarpment rim, accessible with a guide, look east across the full sweep of the Mara ecosystem toward the Serengeti horizon. Early morning light from the escarpment side is exceptional for photography.
