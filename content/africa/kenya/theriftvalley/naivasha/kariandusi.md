...
type: poi
snippet: "A significant Stone Age site with hand axes and obsidian tools on the Rift Valley floor"
latitude: -0.7000
longitude: 36.5000
tags:
  - things_to_do
...
The open-air museum has an excavation trench showing the deposit as it was found, with tools left in situ for viewing. A small shelter houses a display of the site's history and the tools removed during excavation, including large obsidian hand axes of impressive workmanship. The setting — a low cliff above a dry valley with views toward the Rift Valley escarpment — is pleasant.

Kariandusi is on the A104 highway between Naivasha and Gilgil. Any matatu running north from Naivasha will pass the junction; ask to be dropped at Kariandusi. The site is administered by the National Museums of Kenya and charges a small entrance fee.
