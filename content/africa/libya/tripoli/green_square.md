...
latitude: 32.8950
longitude: 13.1811
snippet: "Tripoli's main central square and symbolic heart of the city"
tags:
- things_to_do
- sight
title: Martyrs' Square (Green Square)
type: poi
story: >
  The square has changed names as often as Libya has changed governments. The Italians
  called it the Piazza Italia and built their finest colonial buildings around its edge.
...
The square is surrounded by some of the city's most notable Italian colonial architecture, including the Bank of Libya building and several government ministries. The corniche runs along the waterfront edge, with views across the harbour. The square itself is usually busy with traffic and pedestrians and serves as a useful orientation point when exploring the old city.
