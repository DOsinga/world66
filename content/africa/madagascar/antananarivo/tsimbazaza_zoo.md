...
A natural history museum on the grounds holds paleontological specimens, including the reconstructed skeleton of the elephant bird (Aepyornis), the largest bird ever to have lived, which became extinct in Madagascar within the last few centuries. The zoo is not to international standards in terms of enclosure size, but the animals are well cared for and the setting — shaded paths, ponds, mature trees — makes for a pleasant few hours. It is the most practical place in Tana to see lemurs up close before heading into the wild.
