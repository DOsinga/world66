---
title: "Bandiagara Escarpment Treks"
type: poi
tags:
  - things_to_do
  - sight
...
The escarpment itself — a sandstone cliff rising 500 metres above the plain — is spectacular. The Dogon villages cluster at its base, along its face, and on top of the plateau, each in a slightly different relationship with the rock. The most visited have clearly adapted to tourism; the further along the escarpment you go, the less trodden the path. Abandoned Tellem burial caves, carved into the cliff face above the villages, are visible from below and on some routes accessible. The villages of Bongo, Banani, and Ireli are all within range of Sanga and worth including.

Note: the region has faced security concerns since 2012. Check current travel advisories before going. The situation has varied considerably by area and by year.
