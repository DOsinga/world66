...
type: poi
tags: [things_to_do, sight, walking, wildlife]
latitude: 31.0685
longitude: -3.9698
story: >
  Erg Chebbi is one of only two true ergs — seas of wind-sculpted sand dunes —
  in Morocco; the other is Erg Chigaga, far to the west near M'Hamid. The
...
Camels are available through local guesthouses for those who prefer not to walk. A short camel ride to a bivouac and back is one of the standard Sahara experiences; if you want the full version — sleeping under the stars in a proper tent camp among the dunes — it is worth arranging in advance rather than on the day. The dunes are at their most spectacular in late autumn and winter when the heat is bearable and the sky is reliably clear.
