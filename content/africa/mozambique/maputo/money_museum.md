...
latitude: -25.97
longitude: 32.5742
snippet: Small money museum in the old colonial-era Standard Bank building
tags:
  - things_to_do
  - baixa
  - museum
...
The building itself, with its tiled floors, vaulted ceilings and original teller counters, is at least as interesting as the coins. The museum is small — half an hour will do it — but it sits in the heart of the Baixa and makes a useful pairing with the cathedral and the Iron House.
