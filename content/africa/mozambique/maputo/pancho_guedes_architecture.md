---
title: "Pancho Guedes Architecture Trail"
type: poi
category: Architecture
latitude: -25.967
longitude: 32.59
snippet: Self-guided tour of buildings by Mozambique's most influential modernist architect
tags:
  - things_to_do
  - polana
  - sight
...
Key buildings to find: the **Saipal Bakery** (1954) on Avenida Eduardo Mondlane, with its scalloped concrete roof; the **Smiling Lion** apartment block (1956–58) with its grimacing facade; the **Octopus House** in Polana; **Promotora del Coração de Maria** church; the **Tonelli House** with its forked entry posts; and the **DLouro House** on Avenida Patrice Lumumba. A walking map is sold at the **Casa Comum**, the cultural centre on Avenida Karl Marx, which also runs occasional guided architecture tours.
