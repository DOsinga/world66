...
The walks must be done with guides — independent visitors are asked not to approach nesting turtles, as lights and disturbance can send them back into the water without nesting. Ask at the dive centres in town for the current schedule and which operators are running legitimate conservation-based tours. Some of the hatchling releases later in the season are also open to visitors.
