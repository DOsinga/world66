...
tags:
  ...
  - sight
story: >
  At its peak in 1913, Kolmanskop had a hospital, a casino, a skittle alley, and an ice
  factory — the first in sub-Saharan Africa. The miners and their families lived better
...
The town boomed from 1908, when diamonds were found in the sand underfoot, to the early 1930s when the deposits were exhausted and the richer deposits further south at Oranjemund drew the industry away. A permit is required to enter — available from the Lüderitz museum or directly from the Kolmanskop office, which also runs guided morning tours. The best light for photography is in the two hours after sunrise; go on a weekday to avoid tour buses from Lüderitz.

The Goerke Haus in Lüderitz (the villa of a diamond company manager) has been preserved as a comparison point — showing what these buildings looked like when occupied.
