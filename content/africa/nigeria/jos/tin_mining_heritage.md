---
title: "Tin Mining Heritage"
type: poi
tags: [things_to_do, sight]
snippet: "Old mining pits, dredges, and tailings ponds that built modern Jos"
latitude: 9.8500
longitude: 8.8000
story: >
  The tin and columbite deposits on the Jos Plateau were the basis
  of Nigeria's first major industrial economy. From 1903 into the
  1970s, the British-led Niger Company and Anglo-Oriental Tin
...
A formal mining museum is part of the Jos Museum Complex; for the landscape itself, drive south on the Bukuru–Vom road and stop at any of the marked pull-outs along the way. Hire a local guide if possible: the more interesting sites are not signposted and the history takes some unpacking. The hills, ponds, and granite outcrops together create a landscape unlike anywhere else in Nigeria.
