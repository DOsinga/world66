...
The lighthouse is no longer accessible as a tourist viewpoint — security restrictions apply to the harbour area — but the view of the lighthouse from the old city streets, with the Indian Ocean behind it, is striking. The harbour it guards has been busy with commercial traffic again in recent years, handling container ships and fuel tankers in growing volumes as Mogadishu's economy slowly rebuilds.
