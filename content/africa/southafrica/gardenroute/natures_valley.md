...
The setting is the main attraction. A day can move from beach to river mouth to forest trail without much planning, and the final stage of the Otter Trail reaches the village from the wilder coast to the east.

Nature's Valley is also close to The Crags and Bloukrans Bridge, so it works as a calm base for a more active day. The village itself is not busy, but that is the point: the landscape does most of the talking.
