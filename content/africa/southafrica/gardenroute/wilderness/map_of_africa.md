...
type: poi
snippet: "Hilltop lookout over a river meander that mimics the African continent"
latitude: -33.9700
longitude: 22.6100
tags:
- things_to_do
...
The viewpoint is signposted from the N2 and reached via the Hoekwil road. Stop at the small picnic site at the top. From the same spot, paragliders launch on most days when conditions are right — the cliff faces directly into the prevailing southwesterly and produces reliable lift. Several operators in Wilderness run tandem flights for first-timers; a short flight lands on the beach near the river mouth.
