...
The Melrose Arch precinct itself is a purpose-built upmarket development that lacks character in the way all purpose-built precincts do, but Moyo works well within it. The outdoor terrace is popular for long weekend lunches, which is really how it should be experienced — unhurried, with a decent South African wine, no particular agenda. It is a favourite with Johannesburg's middle class for a reason.
