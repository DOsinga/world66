...
latitude: -6.8074
longitude: 39.2975
snippet: White-walled presidential palace facing Magogoni Bay — visible only from the road.
tags:
- things_to_do
- sight
- architecture
...
You cannot enter or stop in front of it — the guards take a dim view of either — but the road past is a public route and a slow drive-by gives a clear view from the inland side. The lawns sweeping down to the harbour are best seen from the Kigamboni ferry on the return leg.
