...
The route typically takes six to seven days and is considered one of the easier options, with a gradual ascent that helps with acclimatisation. It joins the Marangu Route for the descent. Because it approaches from the drier north side, it can be a good choice during the rainy season when the southern routes are wetter.