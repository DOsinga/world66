...
latitude: 26.0325
longitude: 50.5103
snippet: "Home of the Bahrain Grand Prix, the first Formula 1 race held at night under floodlights"
story: >
  When the Bahrain Grand Prix moved to a night race format in 2014, the circuit became the
...
Outside race season the circuit offers track days, driving experiences, and tours of the facilities. The desert setting — the circuit is surrounded by sand on all sides, with the grandstands rising out of the flatness — gives it a slightly surreal quality that no amount of landscaping has fully eliminated. A short drive from Riffa and easily combined with a day out from Manama.
