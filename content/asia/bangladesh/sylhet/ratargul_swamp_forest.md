...
longitude: 91.9333
story: >
  Ratargul is one of only two freshwater swamp forests in Asia and the only one
  in Bangladesh — a flooded woodland of koroi and hijal trees that stands in
...
The site is now part of a protected reserve, though enforcement is uneven; boat rides are arranged at the entry point and last about an hour. Avoid weekends when the place is overrun by Dhaka day-trippers. In the dry season the swamps drain and the forest is reduced to mud and stumps — interesting in its own way, but visit in monsoon if you can.
