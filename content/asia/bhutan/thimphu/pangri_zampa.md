...
latitude: 27.498
longitude: 89.624
snippet: 16th-century monastery where the royal astrologers reside
story: Pangri Zampa monastery, built in the 16th century, is where the royal astrologers
  of Bhutan live and work. Before any major national decision — from coronations to
  the auspicious timing of festivals — the astrologers here are consulted. The monastery
  also offers intensive residential meditation retreats, which can be applied for by
  serious practitioners through the monastic body.
tags:
- things_to_do
- sight
