...
The market is thoroughly local. Very few tourists find their way here, which makes it all the more worthwhile. The smell of charcoal and grilled meat hits you from the car park. Plastic tables and stools fill the space between stalls. Order chicken satay from one stall, rice and rendang from another, and a cup of teh tarik from a third — mixing and matching from multiple vendors is the standard approach. Go hungry.
