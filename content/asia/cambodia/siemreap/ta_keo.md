...
type: poi
story: >
  Ta Keo was never completed. Work stopped around 1010 AD, possibly because
  lightning struck during the consecration ceremony — considered an extremely
  bad omen that may have caused the project to be abandoned entirely. As a result,
...
The absence of carving, while the result of a historical accident (or a bad omen, depending on which account you follow), means that Ta Keo's structural qualities are more apparent than at any other temple. The proportions are excellent and the grey-green sandstone has an almost modernist quality. It sits between Ta Prohm and the Angkor Thom east gate and makes a logical stop on the "large circuit" that most tuk-tuk drivers follow.
