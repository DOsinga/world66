...
At the northern end, the terrace transitions into the **Terrace of the Leper King**, a smaller platform named after a seated statue found on top (now in the National Museum in Phnom Penh; a replica stands in place). The Leper King terrace is notable for its hidden inner terrace wall: you can walk into a narrow trench between two carved walls, the inner one hidden when the outer was built over it. Both terraces are easily reached from the Bayon and are typically included in any Angkor Thom circuit.
