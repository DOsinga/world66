...
Entry is free but requires advance registration with a passport. The queues can be long on weekends and holidays; go on a weekday morning. The building is enormous and a full visit takes most of a day, so pick two or three galleries rather than trying to see everything. The café inside is basic but functional.
