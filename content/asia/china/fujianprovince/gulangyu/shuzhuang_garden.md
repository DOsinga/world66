...
The garden contains a series of pavilions, bridges, and rock formations in the traditional Suzhou style, but the scale is larger and the sea views give it an openness unusual in classical Chinese garden design. The bridge across the tidal inlet is particularly well positioned, with views in both directions along the coast. The garden is at its most atmospheric at high tide when waves break against the rocks inside the walls, and on overcast days when the sea and sky are the same grey and the garden's formal elements stand out sharply against them.
