---
title: Huangguoshu Grand Waterfall
type: poi
tags:
  - things_to_do
  - sight
...
The main viewpoint platform below the falls is the obvious stop, but the better experience is to go lower — a staircase path descends to the pool level, where the full width of the curtain is visible overhead and the spray becomes dense enough to require a rain jacket. The viewing angle from below is fundamentally different from the platform, and the two together give a sense of the falls' actual scale that neither alone provides.

The rainy season runs from June to September, and this is when the falls are fully impressive. Outside that window, particularly in winter and early spring, the volume drops and the falls narrow. The cave behind the falls is accessible year-round.
