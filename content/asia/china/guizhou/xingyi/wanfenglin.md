---
title: Wanfenglin (Forest of Ten Thousand Peaks)
type: poi
tags:
  - things_to_do
  - sight
...
The area is best experienced from the viewpoints above the village of Wanfenghu, which sits within the landscape at the reservoir below the peaks. Dawn and dusk are the most dramatic times — mist settles in the low ground between the towers at dawn, and the low-angle evening light makes the shadows between the cones visible. In February and March, when rapeseed blooms across the fields, the yellow against the grey-green limestone is the image that appears on most Xingyi tourism materials. The surrounding Buyi villages are accessible on foot from the viewpoint areas, and the people living among the peaks have been growing rice and tending their fields here for centuries.
