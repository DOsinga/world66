...
longitude: 108.4297
story: >
  Zhenyuan's walls were built as a southwestern frontier fortification — the town sat on the
...
Walking the walls takes about an hour and gives a different perspective on the town's topography than the riverside path below. The combination of stone ramparts, overhanging karst cliffs, and wooden riverside houses below creates a layered scene that rewards time spent at the top rather than rushing through. The wall circuit starts near the Zhusheng Bridge and the route is well-signed.
