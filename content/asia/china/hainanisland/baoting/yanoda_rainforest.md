...
longitude: 109.6667
story: >
  Yanoda takes its name from a Li language phrase meaning "this place." The forest
  contains trees several hundred years old and some of the best-preserved secondary
...
Optional add-ons include abseiling, zip-lines over the canopy, and a bamboo raft section on the stream. These are worth doing if you have children or if the group needs something active; otherwise the walking trail alone justifies the visit. Go early to beat the day-tripper buses from Sanya, which typically arrive mid-morning. The air temperature is noticeably cooler than the coast, which is itself a reason to be here during Hainan's hot summer months.
