...
The garden is divided into themed zones — a plant viewing area, an ecological recreation section, a demonstration planting area where you can see crops at different growth stages, and a forest walk through more naturalistic terrain. Tasting the products is part of the experience: the coffee sold at the garden's café is grown and roasted on site, and it is genuinely good — strong, low-acid, and with the slight sweetness that characterises properly ripened Arabica. Allow two hours for a thorough visit.
