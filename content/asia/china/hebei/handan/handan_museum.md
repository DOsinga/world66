...
The museum also displays material from the surrounding region, including pieces that illuminate the connections between the Zhao state and the steppe cultures to the north. The exhibitions are labelled in Chinese and English, and the galleries are spacious and well lit. For a visitor trying to understand why Handan matters in Chinese history, this is the most efficient starting point.
