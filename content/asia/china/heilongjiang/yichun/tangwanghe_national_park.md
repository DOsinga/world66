---
title: "Tangwanghe National Forest Park"
type: poi
tags:
  - things_to_do
  - nature
...
The park is less visited than the forest areas immediately around Yichun city, which is its main advantage. Wildlife in the Xiaoxing'anling includes Amur tiger (very rarely seen), brown bear, wild boar, and a range of boreal birds. Day hikes through the river valley are the standard activity, and the park has basic visitor facilities. Getting here from Yichun requires a bus or private vehicle; the journey takes roughly two hours.
