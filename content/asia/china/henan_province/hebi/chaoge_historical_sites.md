---
title: Chaoge Historical Sites (Qi County)
type: poi
tags:
  - things_to_do
  - sight
...
longitude: 114.1978
story: >
  The last Shang king, Zhòu Xīn, built his Deer Terrace at Chaoge —
  according to tradition a tower so high he could see the Zhou armies
  massing on the plain. When the Zhou conquest became inevitable, he dressed
...
Visitors with a particular interest in the Shang dynasty will find the area adds useful context to the better-known sites at Yinxu in Anyang — Chaoge was earlier and more westerly, and the relationship between the two cities is a matter of active scholarly debate. The countryside around Qi County has a quiet pastoral character that contrasts with the industrial overlay of Hebi itself. Getting there requires a taxi or local bus from Hebi; the journey takes about 40 minutes.
