...
longitude: 114.3400
story: >
  The park is based on "Along the River During the Qingming Festival," a
  five-metre-long Song painting that depicts a single day in Kaifeng around
  1100 CE — the world's largest city at the time. Scholars have spent centuries
  cataloguing every boat, stall, and figure in the scroll; the painting has
...
The evening shows are the highlight — light projections on the lake surface recreate scenes from the original painting, and the water shows incorporate the architectural silhouettes of the park's Song-style buildings. Entry (¥120 or more for evening performances) includes access to the main areas; some performances require separate booking. Allow three to four hours for a thorough visit. The park is best visited on weekdays when the crowds are thinner.
