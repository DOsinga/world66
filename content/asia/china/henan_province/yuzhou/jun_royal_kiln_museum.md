---
title: Jun Royal Kiln Site Museum
type: poi
tags:
  - things_to_do
  - museum
...
The ceramics on display show the full range of what Yuzhou kilns produced: the famous sky-blue and purple Jun glazes, the more unusual crimson pieces that result from the highest copper concentrations in the glaze, and the functional ware produced alongside the imperial pieces. The "kiln-change" phenomenon — the unpredictable colour transformation that happens during firing — is explained clearly here, and the display of pieces at different stages of firing makes the chemistry tangible. Admission is free, which seems surprisingly generous given the quality of the collection.
