...
A faster option combines the cable car from Nanyue town to the upper station with a 4-5 kilometre ridge walk to the summit. The cable car ride is spectacular in itself, crossing heavily forested gorges and offering views down onto Nanyue town. At the summit, a Ming-dynasty temple dedicated to the fire deity Zhurong is still active. On clear days the view from the top extends across the Hunanese lowlands; in cloud — which is common — the summit is often above the mist layer, with ridge-tops appearing like islands.
