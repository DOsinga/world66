---
title: Coiling Dragon Cliff Skywalk
type: poi
tags:
  - things_to_do
  - sight
...
For those comfortable with heights, this is an exhilarating fifteen minutes. The views from the cliff edge are unlike anything accessible by normal walking paths — the exposure is genuine and the scale is significant. For those less comfortable: the option to skip it entirely while still enjoying the mountain's other highlights is straightforward. The two additional glass walkways elsewhere on the plateau are shorter and slightly less exposed, useful for easing into the experience.
