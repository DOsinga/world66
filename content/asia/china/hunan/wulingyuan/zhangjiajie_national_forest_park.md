...
The park is divided into several walking zones. Huangshizhai is the main elevated area, reached by cable car or a steep two-hour ascent; from the summit ridge the columns are visible in every direction, stretching to the horizon in rows and clusters that look improbable from any angle. The Yuanjiajie area, reached via the Bailong Elevator, holds the most-photographed single feature: the column unofficially known as Avatar Hallelujah Mountain. The valley floor walk along Golden Whip Stream is the park's best sustained hike — several kilometres of path beside a clear river, surrounded by columns that close overhead and block the sky.
