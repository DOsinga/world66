...
The market is best from around 6 PM to 10 PM in summer, when the heat of the day has eased and the temple grounds are lit up. A complete tasting circuit of the market costs almost nothing — a few yuan per item — and provides a better introduction to Inner Mongolian food culture than any sit-down restaurant at any price. The vendors near the temple gate tend to be slightly more tourist-oriented (higher prices, more English signs); the better value is a block or two further back in the residential streets.
