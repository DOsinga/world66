---
title: Dafeng Milu National Nature Reserve
type: poi
tags:
  - things_to_do
  - sight
...
The reserve covers 78 square kilometres of wetland and coastal grassland and can be toured on foot or by vehicle. Guided tours are available and recommended — the terrain is flat but the reserve is large enough to require transport, and guides know where the herds currently are. The best time to visit is spring (March–May) when calves are visible alongside the herds, or autumn when the stags are in rut. A combined day trip covering both the milu reserve and sections of the bird wetlands makes a full day's excursion from Yancheng.
