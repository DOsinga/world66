...
The Putuo Temple on the north of the island is the most significant religious building, a Ming-era complex built around a natural rock formation that includes a Guanyin shrine and several smaller halls. The walk around the island's perimeter takes two to three hours and passes all the main sites. Ferries run year-round but service is reduced in winter; check the schedule before the trip. Accommodation is available on the island if you want to avoid the day-trip crowds.
