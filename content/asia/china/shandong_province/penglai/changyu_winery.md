---
title: "Changyu International Wine City"
type: poi
tags:
  - things_to_do
  - sight
...
Wine tasting tours are available (book in advance on weekends); the museum covers Chinese wine history from the Han Dynasty through the nineteenth-century introduction of European varieties. The setting — a French château visible above the vineyards with the Bohai Sea in the distance — is unlikely but not entirely implausible in a region that has been growing wine grapes for over a century. Entry to the museum and a basic tasting is around ¥60.
