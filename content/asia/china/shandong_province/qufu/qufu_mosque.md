...
The mosque is an active place of worship, open to respectful visitors outside prayer times. Its presence in this most Confucian of Chinese cities is quietly interesting: the two traditions have coexisted here for centuries, and the architectural similarity between the mosque and the Confucian temples on the same streets reflects a deep cultural integration that is easy to miss.
