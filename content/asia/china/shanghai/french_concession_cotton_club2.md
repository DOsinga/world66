...
Cafés here range from minimalist specialty coffee bars to terrace operations that spill onto the pavement under the plane trees. Weekends bring significant queues at the most photographed spots. The architecture is the context for the café culture — coming here purely for coffee misses the point; coming for the combination of good coffee and extraordinary streetscape is what the area is for.
