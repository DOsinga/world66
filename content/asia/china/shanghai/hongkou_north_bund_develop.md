...
The North Bund Skywalk — a 1.2-kilometre elevated pedestrian promenade being developed above the riverbank — is intended to provide a continuous walking route from Suzhou Creek north. The neighbourhood is in active transition; the combination of the new towers and the surviving 1920s-era commercial buildings on Tanggu Road creates the kind of temporal layering that defines Shanghai.
