---
title: "Shanxi Noodles, Jincheng Style"
type: poi
tags:
  - eating_out
  - restaurant
...
Sour and spicy dishes using the local mountain vinegar are common across the menu. Order the vinegar on the side rather than pre-mixed into sauces if you want to gauge the correct amount — Shanxi vinegar is considerably stronger than rice vinegar and the balance varies by preference.
