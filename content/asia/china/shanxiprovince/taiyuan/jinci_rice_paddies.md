...
The paddies are visible from the temple entrance road and from the outer walls of the complex. Local vendors sell steamed rice products near the entrance using the Jinci grain, which has a slightly sticky, fragrant quality distinguishable from the machine-milled rice available elsewhere.
