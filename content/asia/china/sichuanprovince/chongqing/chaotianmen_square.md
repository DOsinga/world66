...
The square is dominated by a large outdoor staircase descending to the river and a dock complex where Yangtze cruise ships depart. A massive new development — the Raffles City complex, shaped like two leaning towers connected by a sky bridge — now dominates the skyline above the square. Ferries cross to the south bank from here, and the square is busy day and night with tourists, commuters, and fishermen.
