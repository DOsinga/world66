...
longitude: 102.6200
story: >
  The red sandstone formations above Langmusi take their colour from iron oxide
  in the rock — the same geochemical process that colours the Zhangye Danxia
  landforms further north in Gansu, though on a smaller scale. The prayer flags
...
The trail begins from the village and is well-worn. The altitude — the summit is around 3,700 metres — makes the final approach steeper than it looks and slower than expected for those not acclimatised. Start in the morning before weather builds; thunderstorms are common in the afternoons during summer months and the exposed summit ridge is not a safe place to be caught in lightning. The descent to the village on the far side, following a different path, adds variety if you have the time.
