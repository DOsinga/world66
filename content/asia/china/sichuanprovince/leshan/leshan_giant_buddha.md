...
There are two ways to experience the statue. The cliffside staircase descends from the top of Lingyun Mountain to the base, giving you the full scale at ground level and a close look at the carved feet and lap. The queue for this can be very long — allow at least two hours on busy days, and considerably more during Chinese public holidays. The alternative is to take a river boat from the dock below, which gives you the full frontal view in a few minutes; this is where photographs are taken. The boat trip does not replace the staircase descent if you have time — the two perspectives are entirely different.

The drainage system built into the statue's hair, arms, and clothing channels rainwater away from the rock, and this engineering has kept the statue structurally intact for 13 centuries. Without it, the soft sandstone would have eroded far faster.
