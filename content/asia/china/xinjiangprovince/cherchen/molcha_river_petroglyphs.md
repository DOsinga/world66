---
title: Molcha River Petroglyphs
type: poi
tags:
  - things_to_do
  - sight
...
Getting there requires a local guide and either a hired vehicle or considerable patience with local transport. The road from Cherchen follows the Molcha River valley into the hills, passing increasingly dramatic scenery as the desert gives way to scrubby mountain slopes. A full-day round trip is the minimum; some visitors camp overnight to have time to explore the full extent of the carvings. The guide is essential not only for logistics but for locating the best sections of the cliff, which stretches for several kilometres.
