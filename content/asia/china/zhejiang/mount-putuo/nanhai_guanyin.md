...
The platform around the statue's base functions as an active shrine, with incense burners, flower offerings, and a steady stream of worshippers circling the platform in clockwise direction as required by Buddhist practice. The sea view from the platform is the best on the island — on a clear day the outer Zhoushan islands are visible — and the combination of the sacred image and the open ocean is the definitive visual of Mount Putuo. The site is often busy, but early morning visits before the tour groups arrive have a different quality.
