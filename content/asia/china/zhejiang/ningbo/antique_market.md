...
For genuine purchases, the wood carvings are the most reliable Ningbo-specific finds: antique carved panels, furniture doors, and altar pieces that reflect the extraordinary skill of Ningbo's traditional carvers. Prices require negotiation and authentication requires knowledge, but for visitors with some experience of Chinese antique markets, the Gulou market is more interesting and less tourist-managed than the official antique centres of Hangzhou and Shanghai.
