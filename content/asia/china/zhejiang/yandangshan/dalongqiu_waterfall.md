...
The gorge leading to the falls is itself worth the walk — about forty minutes from the park entrance through a canyon of volcanic rock, with smaller cascades and moss-covered stones along the streambed. The path is partly covered by an old walkway bolted to the cliff face, which adds to the slightly precarious pleasure of the approach. Dalongqiu is most spectacular in spring and early summer, when rainfall in the mountains is highest; in dry autumn the flow is reduced to a thin strand down the same cliff.
