...
To eat it properly, go to a mid-range local restaurant rather than a hotel dining room — the best versions are served at no-frills places in the old town where the fish is freshest and the recipes haven't been moderated for outside palates. Hotel Riyaz is the most frequently mentioned name for pot biryani; for fish curry, ask locals for current recommendations as quality shifts with the cook.
