---
title: Trilinga Sanghameshwara Temple
type: poi
tags:
  - things_to_do
  - sight
...
longitude: 79.0242
sources:
  - https://en.wikipedia.org/wiki/Trilinga_Sanghameshwara_Temple
story: >
  The temple is classified as a HariHara Kshetram — a site that holds both Shaivite
...
The temple was built during the reign of Kakatiya king Prola II (1115–1157 AD), placing it at the height of the Kakatiya dynasty that produced so much of this region's medieval religious architecture. The main festivals — Maha Sivaratri and Sreerama Navami — draw large numbers of pilgrims from across the district. Outside festival season the site is quiet. It is straightforward to combine a visit here with Bommalagutta if you have a vehicle.
