...
Today it is a fishing village with a peaceful, unhurried character. The beach itself is long, largely empty, and backed by casuarina trees. The water can be rough, particularly during and after the monsoon, so swimming requires caution. Fishing boats are pulled up on the beach in the mornings and evenings; the catch goes quickly to local buyers. There is minimal tourist infrastructure — a few chai stalls and nothing much else — which makes it exactly the kind of place that rewards visitors who are not looking for facilities.
