...
Daman is technically dry-adjacent — Gujarat, which surrounds it on three sides, has strict prohibition, so the territory attracts weekend visitors from across the Gujarat border specifically to drink. This gives the town a slightly odd character on weekends. Getting here is straightforward: Vapi station on the Mumbai–Ahmedabad main line is about 10 kilometres away, with shared taxis and buses covering the distance. The closest airport is at Surat, though most visitors travel by train from Mumbai or Ahmedabad.
