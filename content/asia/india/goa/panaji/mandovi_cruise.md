...
latitude: 15.5019
longitude: 73.8281
snippet: "Sunset boat trip along the Mandovi with dance performances on board"
tags:
- things_to_do
- sight
score: 5.6
...
Several operators run the same basic itinerary at different price points. Tickets are sold from kiosks along the jetty an hour before each cruise. Drinks (including beer and Goan rum) are available on board. Combine with a meal at one of the riverfront restaurants on either side of the embarkation point.
