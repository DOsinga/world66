...
The temple is best known for a solar phenomenon that occurs on the evening of Makara Sankranti (January 14th or 15th): the rays of the setting sun pass through a window, align between the horns of the stone Nandi in the courtyard, and fall directly onto the Shivalingam inside the cave. It draws large crowds. Outside that event, the temple is a quiet and atmospheric stop — less visited than the Bull Temple, and the cave setting is genuinely striking.
