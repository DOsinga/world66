...
Swimming at Ullal requires caution — the currents near the estuary mouth can be strong, and the surf here has no lifeguards. Local families come in the evenings and on weekends, and there are a few shack-style restaurants and stalls near the main access point. The nearby village of Ullal has the Somanatha Temple, one of the important Shiva temples of coastal Karnataka.
