---
title: Lonar Wildlife Sanctuary
type: poi
tags:
  - things_to_do
  - sight
...
The lake itself attracts a long list of resident and migratory waterbirds in winter, including occasional flamingos, herons, and ducks moving south from Siberia. There is no entry fee at present, and access is via the same path that descends from the crater rim.
