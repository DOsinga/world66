...
The setting — a fold in the hills wrapped in dense forest, with the spring tumbling between the rock chambers — is the real attraction. The road in is rough, but it is one of the more atmospheric short excursions from Panchgani, particularly during the monsoon when the spring runs full. Allow an hour and a half for the round trip from town.
