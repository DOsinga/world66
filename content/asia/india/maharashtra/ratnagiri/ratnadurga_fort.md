...
longitude: 73.2952
story: >
  Originally built by the Bijapur Sultanate and rebuilt by Shivaji in 1670,
  the fort changed hands repeatedly between the Marathas, the Siddis, and
...
The fort is compact enough to walk around in an hour, and there is no entry fee. Come in the late afternoon for the light and to watch the fishing boats heading back to harbour. The Bhagwati Temple inside the walls is active, so dress modestly if you plan to enter.
