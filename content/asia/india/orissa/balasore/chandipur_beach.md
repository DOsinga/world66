...
The beach is backed by casuarina forests and is reasonably clean for a public beach in this part of India. The tidal phenomenon is at its most dramatic around the time of the new and full moon, when tides are strongest. Note that Chandipur is also the location of India's Integrated Test Range missile testing facility, which occasionally results in access restrictions — check locally if your timing is critical. The beach itself is free to access when open.
