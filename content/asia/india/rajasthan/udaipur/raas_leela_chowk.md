...
Boats run regularly from late afternoon. Buy tickets at the jetty (₹400 for a basic tour, more for sunset and Jag Mandir landing). On a busy evening expect a queue; if you want a quiet experience, take the first morning boat instead.
