...
The restaurant is modest in size and often busy with locals at lunchtime. Order the set meal for the best value. This is the kind of place that can move addresses, so ask locally for the current location if you cannot find it on MG Road.
