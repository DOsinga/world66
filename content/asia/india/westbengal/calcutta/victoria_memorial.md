...
type: poi
story: >
  The architect Lord Curzon insisted the building be made entirely of white Makrana marble —
  the same stone used for the Taj Mahal. Getting enough of it proved so difficult that construction
  took 21 years, from 1900 to 1921. Curzon had left India long before the doors opened; by then
  the Raj he was commemorating had only 26 years left to run.
score: 9.2
---
