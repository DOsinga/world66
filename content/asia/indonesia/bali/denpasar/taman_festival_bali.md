---
title: Taman Festival Bali (Abandoned Theme Park)
type: poi
tags:
  - things_to_do
  - sight
...
Urban explorers and photographers know the site well, though official access is uncertain — the property is privately owned and visits require navigating local gatekeepers or guides who know the back routes in. The site is somewhat between Denpasar and Sanur; several tour operators in the area offer unofficial access. The overgrown quality worsens in the wet season (November–April) when vegetation grows fastest, but it is most accessible in the dry months when the paths between structures are easier to navigate.
