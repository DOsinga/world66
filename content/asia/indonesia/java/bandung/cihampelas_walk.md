...
The Cihampelas Walk (locals call it Ciwalk) at number 160 is a more conventional open-air mall built around landscaped courtyards — useful for cooler upmarket shopping, restaurants and a cinema, but the real reason to come is the eccentric strip of street-front shops on either side. Bargaining is expected; the marked prices are starting points.
