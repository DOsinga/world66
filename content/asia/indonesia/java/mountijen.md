...
image_source: https://commons.wikimedia.org/wiki/File:Crater_of_Kawah_Ijen_volcano,_East_Java,_Indonesia,_20220821_0612_9731.jpg
latitude: -8.0583
loc_type: feature
longitude: 114.2417
sources:
- https://en.wikipedia.org/wiki/Kawah_Ijen
...
The crater lake — [Kawah Ijen](/asia/indonesia/java/mountijen/kawah_ijen) — is the world's largest highly acidic crater lake, a one-kilometre-wide turquoise body of water with a pH below 0.3, more corrosive than battery acid. At the lake's edge, sulphuric gases emerge from volcanic vents, condense into liquid sulphur, and then ignite as they hit the air — creating the [blue fire](/asia/indonesia/java/mountijen/blue_fire) that is Ijen's signature spectacle. The flames are visible only in darkness and require an early-morning hike from the Paltuding basecamp to the crater rim, then a steep descent to the lakeshore.
