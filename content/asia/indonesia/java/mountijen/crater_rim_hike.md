...
For the blue fire, start before 1am — the blue flames are only visible in total darkness, and most days they begin to disappear as dawn approaches. For those who miss the timing or prefer not to hike in darkness, a daytime or sunrise hike is still richly rewarded: the crater lake views are spectacular, the miners' activity is fascinating to observe, and the volcanic landscape is unlike anything else in Java. A gas mask is essential for anyone descending into the crater; masks can be rented at the Paltuding entrance. Entry fees apply for all visitors — around 100,000 IDR on weekdays, 150,000 IDR on weekends for foreigners.
