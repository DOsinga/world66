...
latitude: -8.4539
longitude: 119.5808
snippet: Submerged pinnacle rated one of the best dive sites in the world
tags:
- things_to_do
- sight
title: Batu Bolong
...
Diving Batu Bolong requires a good level of experience — the currents are strong and the timing critical — and a reputable dive operator who knows the site. Most liveaboard and day-trip operators from Labuan Bajo include it in their itineraries. The site can only be dived when conditions are right; check forecasts and be prepared to miss it if the current is too strong.
