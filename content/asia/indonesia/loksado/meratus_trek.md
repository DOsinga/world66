...
The trail takes two days at a moderate pace, though shorter variations are possible. Guides are available in Loksado and are strongly recommended — not because the path is technically difficult, but because the villages along the way require introductions, and a local guide opens doors that would otherwise stay closed.

Overnights in Haratai mean staying with local families in longhouses. Conditions are basic: sleeping mats, shared meals of rice and vegetables, no electricity in the evenings. This is part of the point. The hospitality is genuine and the community is accustomed to occasional visitors without being set up as a tourist destination.
