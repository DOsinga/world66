...
latitude: 32.6575
longitude: 51.6722
snippet: Safavid pavilion whose "forty columns" are twenty plus their reflections
sources:
  - https://en.wikipedia.org/wiki/Chehel_Sotoun
story: >
  The name means "Forty Columns" but the pavilion has only twenty wooden pillars. The
  other twenty are their reflections in the long ornamental pool that stretches in front
  of the portico — a typically Persian play on number and appearance. Shah Abbas II used
  the pavilion to receive foreign ambassadors, and the large paintings inside the
  reception hall depict those occasions with considerable diplomatic swagger.
tags:
  - things_to_do
  - sight
  - historic
