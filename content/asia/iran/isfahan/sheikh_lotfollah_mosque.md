...
latitude: 32.6574
longitude: 51.68
story: 'Unlike most mosques, Sheikh Lotfollah has no minaret and no courtyard — because
  it was built as a private mosque for the royal harem. An underground passageway
  connected it directly to the Ali Qapu Palace opposite, so that the women of the
  court could cross the square unseen.
