---
title: "Shah Mosque (Masjed-e Shah)"
type: poi
tags:
  - things_to_do
  - sight
...
Non-Muslim visitors may enter during non-prayer hours with appropriate dress. Women require a chador, which can usually be borrowed at the entrance. The interior courtyard, with its central pool reflecting the main iwan, has the quietude that the bazaar immediately adjacent does not. Photography is generally permitted in the courtyard.
