...
The museum's exhibits include models, historic tools, and photographs showing how qanats are constructed and maintained. A working ab anbar (underground cistern) in the basement gives a direct experience of the cooling system that once supplied every household. The building itself, with its wind towers and tiled interiors, is as interesting as the exhibits. Audio guides are available in English.
