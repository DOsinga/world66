...
The reserve contains two main wadi systems: Wadi David, with its famous waterfall at the end of an easy hour-long trail, and the slightly harder Wadi Arugot, which leads to a larger waterfall in a narrower canyon. Both trails are well marked and scenic. Entry is paid; buy tickets at the gate and ask for the trail map. The reserve is open daily, but hours and trail access can change seasonally.
