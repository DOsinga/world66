...
Inside the park, the rebuilt turrets and connecting passageways can be explored. The view from the walls across to Kenroku-en, directly adjacent, is excellent. The park is free to enter; the reconstructed buildings have a small admission charge. The best approach is to combine the castle with Kenroku-en, which are separated by only a path.
