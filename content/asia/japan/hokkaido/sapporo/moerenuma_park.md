...
The scale makes it work. Moerenuma covers 189 hectares, and the ideas that would feel precious at garden size feel natural when you have that much space to move through them. The park is about 30 minutes from central Sapporo by subway and bus, which keeps it relatively quiet on non-summer weekdays. Go in clear weather — the interplay of the sculptural forms with the sky and the mountains visible to the west is what makes it. In winter the hills become sledding slopes, which adds a layer of practical use that Noguchi probably would have approved of.
