---
title: "Kiso River Ukai (Cormorant Fishing)"
type: poi
tags:
  - things_to_do
  - sight
...
Tours run on Tuesday, Wednesday, and weekend evenings (weather permitting). A typical tour lasts about two and a half hours and includes dinner on board before the fishing begins. Reservations are essential — the boats fill quickly, especially on weekends. The view of the fire-lit fishing boats with Inuyama Castle behind them is exactly as atmospheric as it sounds.
