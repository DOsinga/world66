...
The second is the temple's spectacular display of *momiji* (Japanese maples), which in mid- to late November fill the slope behind the main hall with overlapping waves of red, orange, and yellow leaves. The temple is open in the evenings during this period for crowded but unforgettable illuminations. Outside autumn the temple is calmer; the multi-level wooden walkways, the small pagoda on the hillside, and the pond garden reward an unhurried hour.