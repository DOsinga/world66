...
Permanent exhibitions trace the history of manga from Edo-period satirical prints onward, with sections on global comics and on the production process — pen nibs, inkpots, screen tones, and storyboards. The museum has a working manga café and a portrait corner where a resident artist will sketch you in *anime* style. A genuinely happy place; allow a full afternoon if you read Japanese.