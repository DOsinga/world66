---
title: Wara Art (Uwasekigata Park)
type: poi
tags:
  - things_to_do
  - sight
latitude: 37.8167
longitude: 139.0500
snippet: Giant sculptural animals made from leftover rice straw, displayed each autumn
story: >
  The Wara Art project began in 2008 when art students from Musashino Art University
  were invited to Niigata to solve a practical problem: what to do with the enormous
...
The sculptures are on display each September and October, and draw visitors from across Japan. The park itself, set around the coastal lagoon at Uwasekigata, is beautiful in any season — a reminder that the Niigata coastline is more than just a transit zone.
