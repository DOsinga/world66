...
type: poi
story: >
  Kegon Falls became notorious in 1903 when a 16-year-old student named Fujimura Misao leapt to
  his death here, leaving carved on a tree a philosophical note questioning the meaning of life.
...
The falls are fed by Lake Chūzenji, which in turn is fed by snowmelt from the surrounding peaks, and the volume is greatest in spring (May to June) and after summer rains. In winter the falls partially freeze, creating a curtain of ice over the central torrent that is spectacular in its own right. Access is from the Chūzenji-ko bus stop; the walk from the lake shore takes five minutes.
