...
The current sign is the sixth iteration, installed in 2014, and uses LED technology to create colour-changing displays and special sequences for events and celebrations. The figure itself — a sprinter in a victor's pose, arms raised, just crossing a finish line — has not changed since the original. Many Osaka restaurants and bars use the image as shorthand for the city. Best photographed from Ebisubashi bridge at night when the canal reflections double the effect.
