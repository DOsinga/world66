...
Omotesando, the wide boulevard running alongside, is the upscale version — high-end architecture (the Prada building by Herzog & de Meuron, the Omotesando Hills complex by Tadao Ando) and international fashion labels. Walk between the two for the full range of what fashion means in Tokyo.
