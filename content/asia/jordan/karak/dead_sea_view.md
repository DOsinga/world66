...
type: poi
snippet: Drop-off view from the castle ridge towards the Dead Sea rift
tags:
  - things_to_do
  - sight
  - viewpoint
...
Sunset is the standout time. The light gets sticky and red, the shadows stretch into the wadis, and the call to prayer rolls up from the town below. Come early enough to find a quiet spot before the tour groups arrive.
