...
The main draw for visitors is the city model on the upper floor: a meticulously detailed scale model of central Astana, complete with miniature ministries, parks, and the Bayterek. Standing over it gives the most coherent sense of how the planned city actually fits together. Other galleries hold the various drafts of the constitution, ceremonial flags, and gifts from foreign heads of state. Combine with the National Museum next door.
