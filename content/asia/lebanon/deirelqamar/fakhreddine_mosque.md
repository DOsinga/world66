...
The mosque is still in use; visitors can usually enter outside prayer times if a custodian is around. The interior is plain — whitewashed walls, a simple mihrab — but the proportions are excellent and the dome catches the light beautifully in late afternoon. Shoes off, modest dress, and a small donation are the form.
