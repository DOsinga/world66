---
title: Monastery of Saint Anthony of Qozhaya
type: poi
tags:
  - things_to_do
  - sight
...
The monastery church is open to visitors and contains a small museum documenting its history, including material related to the early printing press. A cave behind the church, traditionally used for retreat, can be visited. Qozhaya is still an active monastery, so the atmosphere is genuinely contemplative rather than purely touristic. It makes an easy stop when exploring the lower reaches of the Qadisha Valley from Ehden.
