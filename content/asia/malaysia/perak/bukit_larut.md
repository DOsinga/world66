---
title: "Bukit Larut (Maxwell Hill)"
type: poi
category: Sight
latitude: 4.8585
longitude: 100.7945
snippet: Malaysia's oldest hill station, accessible only by Land Rover from Taiping
tags:
  - things_to_do
  - sight
...
At the top (1,250 m), the air is cool and the views — when not socked in by cloud, which is most of the time — sweep across the Larut plain to the sea. There are a handful of bungalows for overnight stays, a couple of walking trails through mossy montane forest, and an old colonial garden. Bookings for the Land Rover and the bungalows must be made well in advance. Bring a sweater and a rain jacket.
