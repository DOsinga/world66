...
latitude: 5.5803
longitude: 101.3733
snippet: 1,175 km² of primary rainforest, one of the oldest on earth, with tigers and Rafflesia
tags:
  - things_to_do
  - sight
  - park
...
The park is accessed from the lakeside town of **Pulau Banding** on the East-West Highway, about three hours' drive north of Ipoh. From there, all movement is by boat across the long fingers of the Temengor reservoir, with a permit and a registered guide. Two- and three-day trips typically include searches for the giant **Rafflesia** flower (the world's largest, up to a metre across), salt-licks frequented by elephants, the Orang Asli aboriginal communities living in the forest, and a chance — slim but real — of glimpsing a tiger. Several lodges offer overnight stays on floating platforms.
