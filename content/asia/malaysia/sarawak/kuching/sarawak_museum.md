...
The collection is dense and genuinely interesting, curated with seriousness rather than showmanship. Allow at least two hours. The garden between the old building and the new wing holds several large traditional longhouse structures used for ceremonies and exhibitions. The museum is a short walk from the waterfront, past the Brooke Memorial and along the road that runs inland from the courthouse.
