...
latitude: 49.6347
longitude: 99.96
snippet: Bronze Age standing stones engraved with stylised deer, west of Mörön
tags:
- things_to_do
- landmark
...
Hire a driver in Mörön (an hour each way on a rough track). No signage, no fee, no other visitors most days.
