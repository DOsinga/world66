---
title: "Trekking to Inle Lake"
type: poi
tags: [things_to_do, sight]
latitude: 20.5500
longitude: 96.6000
story: >
  The multi-day trek from Kalaw to Inle Lake follows routes that Pa-O and Danu
...
The trek is not strenuous by Himalayan standards, but covers around 60 kilometres over three days, with some long uphill stretches. The reward is access to landscapes and communities that a bus journey to Inle simply cannot offer. Two-day versions covering the same ground by vehicle for part of the route are also available for those with less time. Prices include guide, food, and accommodation; expect to pay around $30-40 per person per day with a small group.
