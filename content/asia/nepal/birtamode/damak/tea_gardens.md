...
The gardens are not set up for tourism in any organised way, but walking into the plantations from the edge of town is generally welcomed. The best time to visit is the spring flush (March to April) or the monsoon flush (June to August) when picking is active and the greenery is intense. Bring boots if it has been raining — the paths between the rows get muddy quickly. Some of the larger estates sell tea directly; buying a packet from the source is a straightforward pleasure. The walk from the town centre to the nearest tea garden takes about twenty minutes.
