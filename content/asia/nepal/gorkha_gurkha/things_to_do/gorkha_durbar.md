...
The view from the ramparts on a clear morning is one of the finest in Nepal: the Annapurna and Manaslu ranges laid out in full, with Ganesh Himal to the east. The hike up from the bazaar takes 45 minutes on a stone staircase path; allow two hours to explore the complex properly. Go early to avoid midday haze and to have the terraces largely to yourself.
