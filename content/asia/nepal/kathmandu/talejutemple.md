...
type: poi
story: >
  The Taleju Temple is opened to the public only once a year, during the great Dashain festival
  in September–October. On that single day, thousands of Nepalis queue for hours to enter.
...
Non-Hindus are not permitted to enter the temple at any time; the general public can enter only on the day of Dashain. The exterior and the temple compound can be seen from within Durbar Square. The Taleju temple complex includes several smaller shrines, and the main tower sustained damage in the 2015 earthquake from which it has since been restored.
