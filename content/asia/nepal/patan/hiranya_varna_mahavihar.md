...
score: 8.5
sources:
- https://en.wikipedia.org/wiki/Hiranya_Varna_Mahavihar
story: 'The monastery follows a strict rotation system: every year a different family
  from the Shakya caste sends a young son to live here as a temporary priest, tending
  the main shrine and ringing the bells. The boy, never older than about twelve, must
  be pre-pubescent — the role ends when he reaches adolescence. This practice, which
  dates back centuries, is still observed today.
...
- sight
- buddhist
title: Hiranya Varna Mahavihar (Golden Temple)
type: poi
---
