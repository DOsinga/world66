...
Across the road is the **Gupteshwor Mahadev Cave**, where you can descend a staircase into the same cavern system to see the river thundering through from below. The two together make a half-hour visit. A small entrance fee for each; both can get busy with Nepali tourists at weekends.
