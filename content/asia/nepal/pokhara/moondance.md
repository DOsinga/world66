...
A starter and main with a beer will run to about 2,500 NPR — high by local standards but reasonable by lakeside-international ones. Booking advisable on weekends in October–November when Lakeside is packed with trekkers. On the central strip between the lake and the main road.
