---
title: "Hili Archaeological Park (UAE side)"
type: poi
tags:
  - things_to_do
  - sight
...
Several other tombs, settlement remains, and a small site museum complete the visit. The whole is set in a public park with shade and benches, so it works well as an early-morning visit before the heat. Part of the Al Ain cultural landscape inscribed on the UNESCO World Heritage list.
