---
title: Jabrin Oasis and Date Palms
type: poi
...
The falaj system at Jabrin is part of the larger network of five Oman aflaj inscribed on the UNESCO World Heritage List in 2006. Visitors can see sections of the open channels running through the palm groves, particularly on the approach to the fort from the road. The date harvest in late summer (August to September) is the best time to see the falaj in full use, with water diverted systematically between garden plots according to an allocation system unchanged for generations.
