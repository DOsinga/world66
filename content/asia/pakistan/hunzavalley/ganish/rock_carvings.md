...
The carvings are best visited in the morning light when shadows throw the engravings into relief. A local guide from the village can point out the most significant panels — the density of imagery on some rocks is easy to miss without knowing where to look. The site is unenclosed and free to visit, though a small fee to a local guide is appropriate and appreciated.
