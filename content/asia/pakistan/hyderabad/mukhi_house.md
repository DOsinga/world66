...
The museum inside contains artefacts related to Sindhi culture and the history of the city. The building is notable as an example of a well-preserved pre-Partition mansion, most of which in the old city have either collapsed or been subdivided into unrecognisable housing. It is one of the few places in Hyderabad where the physical evidence of the city's diverse pre-Partition population survives.
