...
The most accessible walks start from the upper end of The Mall near Kashmir Point, where unmarked paths descend into forested side valleys. Early mornings before the crowds arrive on summer weekends are the best time to walk — the forest is quieter, cooler, and more likely to yield glimpses of langur monkeys and the occasional leopard track. The hill birds include a variety of flycatchers and babblers not found in the lowlands.
