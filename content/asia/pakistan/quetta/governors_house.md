...
latitude: 30.1982
longitude: 67.0059
snippet: The old British Residency, a colonial-era sandstone building on Zarghun Road
tags:
- things_to_do
- historic
...
The building is not generally open to the public, but the exterior — set in grounds with mature trees — is visible from the road and gives a sense of the cantonment era that still defines Quetta's eastern district. The cantonment itself, east of the city centre, preserves a grid of straight roads, single-storey bungalows with wide verandas, and institutional buildings (the District Courts, the Commissioner's Office) that feel transplanted from a British garrison town.
