---
title: "Sabtang Stone Village (Savidug / Chavayan)"
type: poi
tags:
  - things_to_do
  - sight
...
longitude: 121.875
story: >
  Ivatan stone houses are built to a design that has not changed fundamentally in centuries.
  The walls are of volcanic stone — sometimes a metre thick — and the roof is packed cogon grass
  layered over a timber frame. The grass insulates in winter and sheds rain in typhoon season.
...
The main villages to visit are Savidug and Chavayan on the island's east side, both reachable from Sabtang's small port. You can walk between them in about an hour along a road that skirts the coast. Savidug is the larger of the two and has a handful of small *carinderias* (local eateries) where you can eat simply. Chavayan is quieter and better preserved. Both are active communities, not open-air museums, so treat them with the respect you would give to any village where people actually live.
