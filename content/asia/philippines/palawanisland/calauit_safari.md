...
Day tours run from Coron (about 2.5 hours each way) and offer a 4×4 game drive through the open grassland followed by a beach lunch. The whole experience is unmistakably an oddity, but the giraffes silhouetted on a Philippine ridge are an image you will not see anywhere else.
