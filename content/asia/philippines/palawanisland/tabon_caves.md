...
The site is reached by a short boat ride from Quezon town and a steep stair climb to the main caves. The interpretation is thin (the best finds are now in the National Museum in Manila), but the setting — jungle-covered limestone cliffs, raptors overhead, an empty bay below — is exceptional. Few visitors make it here, which is part of the appeal.
