...
Parts of the park are already open to the public, with walking paths, sports pitches, and green space that is unusual in a city whose parks have historically been limited. The development is ongoing but the sections already completed give a clear sense of the ambition: Riyadh is trying to create an urban park on a scale that matches its rapid growth. Check the park's social media for current opening hours and accessible sections.
