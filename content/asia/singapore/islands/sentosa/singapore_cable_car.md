...
The cable car functions both as transport and as an attraction in its own right — it is the most scenic way to arrive on the island. Sky dining gondolas are available for a meal with the view. Return tickets are the standard option; one-way tickets can be combined with the boardwalk for a different route back to the mainland.