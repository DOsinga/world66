...
tags:
  ...
  - architecture
  - myeongdong
title: Hwangudan Altar
type: poi
story: >
  In 1897 Korea declared itself the Korean Empire, equal in status to China and
  Japan, and Emperor Gojong performed the Rite of Heaven at the newly built
  Hwangudan altar to mark the declaration. The rite had been forbidden for
...
The tower is small but interesting — an octagonal stone structure with intricate carvings, one of the few physical traces of the brief Korean Empire. It can be seen from the street through the hotel grounds and is sometimes accessible for closer inspection. The site is within walking distance of City Hall and makes a worthwhile stop when exploring the Myeongdong area.
