...
The palace compound is more informal in atmosphere than the grand palaces of Seoul, reflecting its function as a travelling residence rather than a seat of permanent court life. The main ceremonial hall and the king's residential quarters can be entered, and the overall layout — lower-pitched roofs, more intimate scale — differs from the formal Joseon palaces. A traditional archery practice range is active on the grounds on weekends, and costumed guards perform a changing ceremony at the main gate at scheduled times. The palace is inside the western section of the Hwaseong Fortress walls, accessible from the Janganmun gate area.
