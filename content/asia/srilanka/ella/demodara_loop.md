...
It is a quirky stop rather than a must-see, but if you are walking the tracks between Ella and Demodara — about two hours each way — the loop is a natural turnaround point. The Nine Arches Bridge sits roughly halfway, so a one-way walk takes in both sights.
