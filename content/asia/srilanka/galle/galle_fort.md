...
title: 'Galle Fort'
type: poi
snippet: UNESCO-listed seventeenth-century Dutch fortress occupying a rocky promontory
tags:
  - things_to_do
  - sight
  - unesco
...
The fort is best experienced by walking the ramparts in the late afternoon, when the heat eases and locals come out to watch the sunset over the Indian Ocean. The whole circuit is roughly 3 km and takes 90 minutes at a stroll. Inside the walls, narrow streets are filled with art galleries, gem shops, cafes and boutique hotels — increasingly polished, but the old Dutch warehouses, the Groote Kerk and the lighthouse keep the historical bones visible.
