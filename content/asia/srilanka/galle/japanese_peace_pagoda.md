...
type: poi
snippet: White Buddhist stupa on a wooded headland above Unawatuna
tags:
  - things_to_do
  - sight
  - religious
...
The view from the terrace is the real attraction: Unawatuna Bay below, the Galle Fort in the distance, the Indian Ocean stretching out to the horizon. Sunset is the most popular time, but mornings are quieter.
