...
Beyond the statue, the park contains a zoo with native Taiwanese wildlife (modest but free), a number of small temples scattered through the trees, and a network of walking paths that connect to the old fortifications on the ridge above. The hike up from the waterfront takes about twenty minutes and is worth doing on foot rather than by taxi — the views unfold gradually as you climb. Go in the morning if you want the clearest light over the harbour. The park is always open and costs nothing to enter.
