...
latitude: 8.3354
longitude: 98.5031
snippet: "A Muslim fishing village built entirely on stilts over the water"
story: >
  Ko Panyi's improbable football pitch — built from old planks and fishing rafts floating in
...
Most boat tours include a stop here for lunch, and the restaurants are well-practised at feeding large groups. It is worth arriving outside the peak lunch rush if you can — the village has a genuine community life that is easier to see when it is not overwhelmed by tour groups. The floating football pitch at the edge of the village is a remarkable piece of improvisation, still in use.
