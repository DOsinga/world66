...
Entry is by guided tour only, and the guides are knowledgeable about the individual pieces. It is a more intimate experience than a conventional museum, and the objects themselves are of real quality. Plan an hour and a half. It is a good counterpoint to the temples: where the temples show living religious practice, Oub Kham shows the courtly and domestic culture that surrounded it.
