...
longitude: 34.8750
story: >
  Cappadocia's balloon industry takes off before dawn — the pilots chase the cool, stable morning air before
...
Several operators run flights, with prices varying based on balloon size and duration. Book well ahead in peak season (spring and autumn), when flights can sell out weeks in advance. Cancellations due to wind are common; reputable operators will reschedule or refund if conditions are unsafe. Even if you decide not to fly, watching the balloons rise at dawn from a hilltop above Urgup is worth the early alarm call.
