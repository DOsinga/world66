...
The mosque sits adjacent to the covered bazaar (çarşı), which is still an active market selling everything from spices to hardware. This combination — mosque and market — is the classic Anatolian urban arrangement, and here it functions exactly as it always has. Non-Muslims are welcome to visit outside prayer times; remove shoes and dress modestly. The interior is relatively plain but spacious, with a large central dome and a wooden mihrab that dates to an earlier restoration. Worth spending twenty minutes here rather than rushing through — the setting in the bazaar gives it more atmosphere than a standalone visit would suggest.
