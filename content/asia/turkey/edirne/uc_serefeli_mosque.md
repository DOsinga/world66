...
The four minarets are each different, a deliberate display of variety: the tallest has three balconies, another has two, and the remaining two have one each. The courtyard, with its elegant arcaded portico and central ablution fountain, is one of the most pleasant spaces in Edirne to simply sit. The mosque sits close to the Eski Cami and the Ali Pasha Bazaar, making it easy to visit all three in a single walk through the old town.
