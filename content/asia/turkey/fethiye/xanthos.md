...
tags:
  - day_trips
  - sight
snippet: Capital of ancient Lycia, twice destroyed rather than surrendered, now a UNESCO World Heritage Site
latitude: 36.3528
longitude: 29.3186
...
What remains is still impressive — the agora, a Hellenistic theatre, Lycian pillar tombs, and the foundations of temples and civic buildings. The site is spread across a large area and requires a good hour to explore properly. It is about 60 km from Fethiye and is usually combined with a visit to Letoon nearby. The setting — elevated above a broad valley with the Taurus Mountains visible in the distance — is spectacular.
