...
type: poi
category: Sight
address: "Al Zorah, Ajman"
latitude: 25.4361
longitude: 55.4883
snippet: "Mangroves, lagoons and flamingo flocks on the north edge of the emirate"
tags:
- things_to_do
- sight
...
Half the area is given over to a resort and golf course, which keeps the access roads in good shape but means the "wilderness" feeling is moderated. Best visited at dawn or dusk, both for the wildlife and to dodge the heat. The lagoon-side restaurants are popular at sunset.
