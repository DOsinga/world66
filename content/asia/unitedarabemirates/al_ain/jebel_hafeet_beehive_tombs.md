---
title: "Jebel Hafeet Beehive Tombs"
type: poi
latitude: 24.094
longitude: 55.785
...
The tombs are made of undressed limestone blocks fitted together without mortar in a corbelled technique that allows the dome to stand without any central support. Each tomb is roughly two to three metres high, shaped like a flattened hemisphere, with a narrow entrance passage on one side. When excavated, they were found to contain multiple individuals along with grave goods: pottery from the Jemdet Nasr period of ancient Iraq, copper weapons and tools, and beads that indicate long-distance trade connections.

Access the site by driving partway up the Jebel Hafeet road and turning off onto the gravel track that leads toward the tomb clusters on the right (eastern) side of the mountain. A four-wheel-drive vehicle helps but is not strictly necessary in dry weather. You can walk among the tombs — they are unfenced and unguarded — which is both a privilege and a responsibility. Nothing has been restored; what you see is largely as the tombs have stood for five millennia.
