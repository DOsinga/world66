...
latitude: 16.4713
longitude: 107.5819
snippet: Long An Palace housing the finest collection of Nguyen imperial objects
tags:
- things_to_do
- museum
title: Hue Museum of Royal Fine Arts
type: poi
story: >
  The museum is housed in Long An Palace, built in 1845 for Emperor Thieu Tri as a
...
The collection spans six exhibition rooms. The most striking pieces are the imperial robes embroidered with dragons and phoenixes, the inlaid throne furniture, and the bronze censers used in ritual ceremonies. Allow an hour. The museum is at 3 Le Truc Street inside the Imperial Enclosure; admission is included with the general Citadel entry ticket.
