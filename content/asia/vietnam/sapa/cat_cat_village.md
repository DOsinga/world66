...
longitude: 103.8333
story: >
  Cat Cat takes its name from the sound of the looms that used to fill the village —
...
The path has become busy with tourists, which has led to some commercialisation — souvenir stalls are everywhere. But the valley itself is beautiful regardless, and the walk down and back (about 2 hours) gives a reasonable introduction to the landscape. The waterfall at the bottom of the path has a café. For a less-visited experience, take the path on to Lao Chai and Ta Van villages instead, which requires a guide but sees far fewer tourists.
