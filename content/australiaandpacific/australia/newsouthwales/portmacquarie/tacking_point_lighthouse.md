---
title: Tacking Point Lighthouse
type: poi
tags:
  - things_to_do
  - sight
latitude: -31.4756
longitude: 152.9348
snippet: NSW's oldest lighthouse, perched on a headland above Lighthouse Beach
story: >
...
The lighthouse is the southern terminus of the Coastal Walk from Town Beach — about 9 kilometres of path that passes through Flynns Beach, Nobby's Beach, and Shelly Beach on the way south. It takes two to three hours to walk the full length one way, and you can arrange a return taxi or walk sections rather than the whole route.

The area around the lighthouse is also one of the better surf spots in the region, with consistent swells breaking along the beach below. Access is via a short walking track from the car park off Matthew Flinders Drive.
