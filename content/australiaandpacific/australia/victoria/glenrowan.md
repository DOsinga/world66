...
The town has built almost its whole visitor identity around that event. Some of it is kitsch, some of it is genuinely useful, and the best approach is to lean into both. Walk the siege precinct, see the oversized Kelly statue, and then use the newer interpretive centre or old animated attractions to fill in the story.

Glenrowan is not worth a long detour for everyone. But if you are already on the Hume Freeway or exploring Victoria's high country, it is a memorable stop with a stronger identity than many larger towns.
