...
longitude: 122.24307
story: >
  Sun Pictures opened in 1916 and has been in continuous operation ever since,
  making it the world's oldest operating outdoor cinema. For much of its early
  history it had racially segregated seating — a legacy of the rigid social
...
The cinema screens films nightly, including current releases, in an open-air setting. The corrugated-iron walls, the deckchairs, the night sky above, and the bats that fly overhead during the screening give it a character that no multiplex can replicate. This is not a heritage museum piece — it is a working cinema and a genuine pleasure to use.
