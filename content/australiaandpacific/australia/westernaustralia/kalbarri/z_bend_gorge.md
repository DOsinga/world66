...
A harder trail descends 200 metres into the gorge to the river itself — a 4.2-kilometre return trip with some scrambling over rocks required. The swimming hole at the bottom is one of the most appealing in the park, and the sense of enclosure in the gorge is completely different from the rim views. Carry plenty of water; the descent is exposed and the temperature in the gorge can be significantly warmer than on the plateau. The trail is marked with red arrows and is achievable for fit walkers, but takes 2-3 hours return.
