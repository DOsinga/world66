...
The site is small and can be walked in twenty minutes. It is set back from the road on a grassy headland with picnic shelters and a view both ways along Agat Bay. The reef at low tide is exposed almost to the line the Marines had to cross — useful for understanding the difficulty of the assault. There is no entry fee and a small visitor information point with toilets.
