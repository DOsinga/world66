---
title: Robert Louis Stevenson Memorial Site
type: poi
tags:
  - things_to_do
  - sight
...
longitude: 173.7883
story: >
  Stevenson arrived in August 1889 and was initially refused permission to land by Tem Binoka,
...
The site itself is quiet — a clearing near the lagoon edge with a stone marker. There is little to see beyond the setting, but the setting is remarkable: the same lagoon, the same palms, the same low horizon that Stevenson described. Bringing a copy of *In the South Seas* transforms the visit completely.
