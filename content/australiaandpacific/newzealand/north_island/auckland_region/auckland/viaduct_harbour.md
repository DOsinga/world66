...
sources:
  - https://en.wikipedia.org/wiki/Viaduct_Harbour
story: >
  The Viaduct Basin was transformed from a working fish-processing wharf into an 
  international waterfront precinct to host the America's Cup in 1999–2000, when 
...
The adjacent Wynyard Quarter, developed in the years since the Viaduct's makeover, has added a more residential and market-oriented character to the waterfront strip — the weekly Wynyard Quarter Farmers Market is worth a stop on a Saturday morning.
