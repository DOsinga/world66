...
latitude: -36.894
longitude: 175.8329
snippet: "Dig your own hot pool in the sand at low tide"
story: 'The thermal activity here comes from magma heating groundwater deep below
  the beach. The hot springs have been known to local Māori for centuries — the area
  is part of a reserve that acknowledges its significance to the local iwi, who used
  the waters for cooking and healing.
