...
The circuit is typically done in three or four days using DOC huts. Booking is required from late October to April. The ridge section between Luxmore Hut and Iris Burn Hut is exposed and can be dangerous in bad weather — check the forecast before heading up. Outside the booking season (May–October) the track is open for independent use without hut bookings, and is almost empty.
