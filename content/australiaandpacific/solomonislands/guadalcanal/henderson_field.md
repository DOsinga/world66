...
type: poi
snippet: "The WWII airfield that decided the Pacific campaign — now Honiara's international airport"
tags:
  - things_to_do
  - sight
  - historic
...
A monument to the Marine and Navy airmen who flew from the field — the famous "Cactus Air Force" — stands near the modern terminal, with plaques listing the squadrons that operated here. Walking the perimeter on the south side, you can still find revetments and overgrown earthworks. The road east from the airport leads to Bloody Ridge, the Tenaru, and Red Beach, so most visitors take in the airport monument on the way to those sites rather than as a separate trip.
