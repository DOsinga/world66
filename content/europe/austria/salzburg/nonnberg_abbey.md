...
The nuns are an enclosed order, so most of the convent is off-limits, but the church and cemetery are open and almost always empty. Get here in the late afternoon when the light slants through the choir windows.
