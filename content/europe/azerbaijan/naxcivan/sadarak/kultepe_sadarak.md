...
The mound itself is unimpressive to look at — a low grassy rise on the flatlands — but the depth of history beneath it is substantial. There is no visitor infrastructure at the site; it is of interest mainly to those with an existing curiosity about Caucasian prehistory. The Nakhchivan State Museum in the capital has the best collection of finds from Kultepe and nearby sites, and is the better starting point for understanding the region's archaeological significance.
