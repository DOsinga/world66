...
The museum provides headphones as you walk in: as you approach each exhibit, the audio automatically plays a recording of that instrument. The effect is atmospheric and makes a museum that could be dry into one that stays with you. The rooftop café has one of the better views over the Upper Town and, on a clear day, towards Laeken. Allow two hours minimum; the serious enthusiast will want a full afternoon.
