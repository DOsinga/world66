---
title: "National Library (Vijećnica)"
type: poi
latitude: 43.8577
longitude: 18.4320
tags:
...
During the siege, Serbian artillery deliberately set it on fire, destroying over 1.5 million books and manuscripts. The building has been painstakingly restored (completed 2014) and now functions again as the city's main library and cultural venue. The interior — rebuilt to the original 19th-century design — is extraordinary, with a multi-story atrium, galleries, and the original decorative ironwork. Worth visiting even outside of events.
