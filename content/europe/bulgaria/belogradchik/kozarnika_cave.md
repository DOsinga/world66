...
The cave is open to visitors, though access can be limited outside peak summer season — it is worth checking locally before making the trip. The drive from Belogradchik passes through pleasant rolling countryside and can be done by car or, for the fit, by mountain bike. Combine it with a return via a different road for a loop through the Belogradchik hills.
