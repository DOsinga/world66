---
title: "Augusta Traiana Roman Ruins"
type: poi
tags:
  - things_to_do
  - sight
...
The Stara Zagora Regional Historical Museum collects the portable finds from the Augusta Traiana excavations, including mosaics, inscriptions, bronze objects, and architectural elements. The museum is the best place to get a coherent picture of the Roman city; the in-situ remains visible around the centre are atmospheric but fragmentary. Combined with the Neolithic Dwellings Museum nearby, the two sites make a compelling case for the extraordinary depth of human habitation in this part of the Thracian plain.
