...
The museum is small but well-curated and entirely run by volunteers. Opening hours are limited — check locally before making a special trip — but it's worth fitting into an afternoon in St Anne. The archaeological section in particular, covering finds from Longis Common and the nearby Iron Age sites, gives Alderney an historical depth that its small size doesn't immediately suggest.
