---
title: Source of the Kupa River
type: poi
tags:
  - things_to_do
  - sight
...
The spring itself is a deep circular pool, the water a striking blue-green that shifts with the light. The Kupa begins flowing from this point and almost immediately marks the Croatian-Slovenian border, which runs down the centre of the river for most of its length. There is a small traditional restaurant near the trailhead that serves hearty forest-region food — bean soup, smoked meats, game stews — and is a good reason to time the walk for lunchtime.
