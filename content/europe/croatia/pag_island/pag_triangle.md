---
latitude: 44.56255751
longitude: 14.91909027
tags:
- things_to_do
- curiosity
title: Pag Triangle
...
The scale is substantial: the main lines are several hundred metres long, and the triangular form is clear from aerial photography. There is no established visitor infrastructure and reaching the site requires a walk across open karst. It is the kind of place that will reward those who like hunting down minor mysteries on foot, but it is not a conventional sight with explanatory panels or managed access. The coastal scenery around Caska Cove, which the Pag Triangle overlooks, is itself pleasant enough to justify the walk.
