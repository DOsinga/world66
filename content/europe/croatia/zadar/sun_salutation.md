---
title: Sun Salutation (Monument to the Sun)
type: poi
latitude: 44.1176
longitude: 15.2198
tags:
...
The effect is hypnotic, and the disc is large enough that children skate, dance and run across it as the colours shift. Combined with the Sea Organ next door, it makes the waterfront one of the best places in any Croatian city to spend an evening.
