---
address: náměstí Republiky 5, Prague 1 (Nové Město)
latitude: 50.0877
longitude: 14.4291
snippet: Prague's greatest Art Nouveau building, with concert hall and decorated café
tags:
- things_to_do
- sight
- architecture
- stare_mesto
title: Municipal House (Obecní dům)
type: poi
url: obecni-dum.cz
story: >
...
Inside: the Smetana Concert Hall, two café spaces (the French and the American), restaurants, and several decorated salons available for hire. The guided tour is worthwhile for the rooms that are otherwise off-limits. The street-level Kavárna (café) is a fine place for coffee; it is less tourist-blasted than nearby cafes and the interior is genuinely spectacular.
