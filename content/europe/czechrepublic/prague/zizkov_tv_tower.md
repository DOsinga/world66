...
admission: 250 CZK observation deck
latitude: 50.0796
longitude: 14.4507
opening_hours: Daily 09:00–23:00
snippet: Communist-era TV tower with David Černý baby sculptures and rooftop bar
tags:
- things_to_do
- sight
- architecture
- zizkov
title: Žižkov Television Tower
type: poi
story: >
...
The observation deck at 93 metres gives panoramic city views, and there is a one-room hotel suite just below it — the only hotel room in the tower. The base has a restaurant and café. Whether you find the tower hideous or magnificent, it is impossible to miss from anywhere east of the Old Town, and the views from the top are excellent.
