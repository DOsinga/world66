...
longitude: 15.1047
sources:
  - https://en.wikipedia.org/wiki/Balka
story: >
  Balka is unusual among Bornholm's beaches for its fine white sand — most of
...
The beach is well set up for families, with facilities including changing rooms and a kiosk. A short walk south leads to Snogbæk and the rockier stretches of the south coast. In summer, Balka fills with Danish holidaymakers, but it rarely feels overwhelmed. From Nexø it is accessible by bicycle along a flat coastal path, which is the nicest way to arrive.
