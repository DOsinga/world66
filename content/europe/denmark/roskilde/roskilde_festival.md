...
The site is a city in itself during the festival — with camping for most attendees, multiple stages, and a sprawling infrastructure. The non-profit structure, in which all proceeds go to humanitarian and cultural causes, gives the event an unusual atmosphere: less corporate, more community-oriented than comparable events. If you're in Copenhagen in late June and can get tickets (they sell fast), it's worth the short train journey.
