...
Outside festival week the site is quiet, but a visit to understand its scale is oddly worthwhile — the infrastructure is enormous and permanent, and the walk from the station to the main stage gives you a sense of the event's ambition. For the festival itself, book far in advance; tickets sell out months ahead of the lineup announcement, which gives you some sense of how committed the audience is.
