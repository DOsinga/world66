...
The building itself is worth noting — it was expanded and renovated to create a more coherent sequence of spaces, and the interplay between the older structure and the newer additions is handled thoughtfully. The museum café is a decent stop for lunch or coffee, with terrace seating when the weather allows. Entry fees apply; check vejlemuseerne.dk for current opening times and exhibitions.
