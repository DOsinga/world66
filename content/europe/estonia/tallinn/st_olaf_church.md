...
latitude: 59.4403
longitude: 24.7498
snippet: Medieval church with the highest spire in Tallinn and a tower with Old Town views
story: >
...
The church is active as a Baptist congregation today. The tower is typically open for climbing from April to October. The views from the top encompass the entire Old Town, the port, and the glass towers of the business district — a sharp visual summary of Tallinn's history in one sweep.
