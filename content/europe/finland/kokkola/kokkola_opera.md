...
Tickets can be booked in advance through the festival website. The productions are sung in the original language (Italian, German, or Finnish as appropriate) and are accessible even to opera newcomers when the staging is done well — as it often is here. The July festival coincides with the peak of Finnish summer, so evenings are long and light, which adds to the atmosphere of concerts and events held outdoors.

The winter accordion festival is a separate event with a very different atmosphere — packed pubs, folk sessions, and the cheerful din of squeezebox played in every possible style from tango (a Finnish obsession) to blues.
