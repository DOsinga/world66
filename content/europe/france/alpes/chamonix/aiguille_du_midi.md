...
type: poi
tags: [things_to_do, sight, cable_car]
latitude: 45.8793
longitude: 6.8874
sources:
...
At the summit, a glass-floored "Step into the Void" cubicle allows you to stand above a sheer 1,000-metre drop — entirely safe but reliably terrifying. There is also a ridge walkway between the two summit pillars, a restaurant, and a small observation platform facing Italy. In summer, experienced mountaineers use this as the starting point for the Vallée Blanche glacier traverse into Italy. Book tickets well in advance in July and August — queues can run to hours without a reservation.
