...
The museum is one of the more affecting industrial heritage sites in France — less sanitised than some. Allow 1.5 to 2 hours. Tours depart at set times and must be booked in advance; check the website for current schedules. The museum is located in the Couriot district, a short tram ride from the city centre.
