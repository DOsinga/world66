...
latitude: 45.7785
longitude: 3.0864
snippet: Plaque and museum marking where Blaise Pascal was born in 1623
tags:
- things_to_do
- historic
- sight
...
For visitors interested in the history of science, the Pascal connection gives Clermont-Ferrand an additional layer. The experiment on the Puy de Dôme — demonstrating that atmospheric pressure decreases with altitude — was one of the key events in early modern physics. Standing on the summit today, it is easy to understand why a seventeenth-century physicist chose this particular peak.
