...
The opera runs a proper season from early summer through autumn, taking advantage of the influx of thermal visitors. It also hosts ballet, concerts, and occasional pop performances. Programming is serious — this is not a provincial theatre coasting on its architecture — and the combination of a great building, a lively program, and the thermal setting makes an evening here one of the best things to do in Vichy. Check the schedule when booking your visit.
