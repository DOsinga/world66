---
title: Fonsérannes Locks
type: poi
snippet: Nine-lock staircase on the Canal du Midi — one of the engineering wonders of 17th-century France
latitude: 43.330556
longitude: 3.199722
tags:
- things_to_do
...
Watching a boat work through the full staircase takes the better part of an hour — each chamber fills or empties before the next gate opens, and the water moving between chambers is considerable. The walkways alongside the locks give a clear view of the process, and the stone canal infrastructure, shaded by plane trees along the towpath, is UNESCO World Heritage-listed. A parallel structure, the 1980s-era Fonsérannes Water Slope (an inclined plane designed to eliminate the need for locks entirely), sits alongside the original and makes an interesting contrast. It no longer functions but is worth examining as a piece of engineering history.
