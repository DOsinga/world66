...
tags:
  ...
  - sight
story: >
  The entrance chamber is so enormous that during the Second World War the
  occupying authorities used it to assemble aircraft. A grass airstrip ran
...
Visits are guided and need to be booked ahead, especially in summer. The cave is cool and damp year-round, so dress accordingly. Combine it with Niaux and the Parc de la Préhistoire for a proper deep dive into Ice Age Europe.
