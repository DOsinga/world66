...
The arch marks the boundary between the Roman city and what was then outside it — a boundary that the medieval town kept in use. Today it stands in a small square that feels slightly accidental, the arch preserved more by inertia than by design, which gives it an authenticity that a more tenderly curated monument might lack.
