...
latitude: 43.835
longitude: 4.36
snippet: A Roman amphitheatre built around 70 AD, still used for bullfights today
story: >
...
Two tiers of seating are accessible to visitors, and the stone fabric of the building is remarkably intact. From the top rows you get a clear sense of the elliptical design and the engineering logic behind it. The basement passages — where animals and gladiators were held — can be explored on guided tours. Entry is €10; combined tickets covering the Arena, Maison Carrée, and Tour Magne offer better value.
