...
The auditorium seats around 9,000 on stone tiers carved into the **Colline Saint-Eutrope**. Acoustic tests have shown the original design still works — a whisper from the stage carries clearly to the top row. The site is inscribed on UNESCO's World Heritage List together with the Arc de Triomphe. The audioguide is good and includes a 3D reconstruction. Tickets also include entry to the small **Musée d'Art et d'Histoire** across the square.
