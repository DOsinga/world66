...
A waymarked trail from the old town leads through the main boulder field and takes about an hour and a half. The route passes some boulders that have been built into medieval structures — a wall attached to one face here, a wine cellar carved into another there. The light in the late afternoon is particularly good for photography. The walk is not strenuous and the path is well-maintained.
