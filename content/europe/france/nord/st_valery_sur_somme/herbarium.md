...
It takes maybe half an hour to walk through, and it pairs well with a wander along the rampart path immediately above. The setting itself, with the chalk wall on one side and views over the bay on the other, is half the appeal. Entry is free; the garden is open from spring to autumn.
