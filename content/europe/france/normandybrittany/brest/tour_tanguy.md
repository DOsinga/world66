...
The museum is modest but the tower itself is atmospheric, and the position — on a rocky knoll beside the Penfeld with the château and the harbour visible from the top — is excellent. It is free to enter and makes a good companion visit to the Château de Brest across the swing bridge. The dioramas of pre-war Brest are poignant for the city they depict: a dense, medieval urban fabric that no longer exists anywhere but in these models.
