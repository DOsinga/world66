...
Walking toward Honfleur (about 8 km, 2-3 hours at a comfortable pace), the path drops into small valleys, crosses farmland, and passes through stretches of cliff-top scrub before descending to Honfleur's outer harbour. The eastern stretch toward Deauville is gentler and more pastoral — apple orchards, hedgerows, and the occasional farm. Good boots are useful after rain; the chalk becomes slippery when wet and the path is not always well drained. The full Honfleur walk can be done one-way and the return made by bus or taxi, which is the more practical approach.
