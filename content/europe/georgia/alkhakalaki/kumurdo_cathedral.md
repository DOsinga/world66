...
The cathedral is set in fields with sweeping views of the Javakheti plateau and the Lesser Caucasus. There are usually no guards, no ticket, and no other visitors. A caretaker may unlock the interior on request; ask in the village if the door is shut. The drive from Akhalkalaki takes about fifteen minutes on rough but passable roads, and a return taxi from town should not cost much.
