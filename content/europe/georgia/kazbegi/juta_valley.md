...
The valley is far quieter than the Truso route or the path to Gergeti Trinity Church. In midsummer the meadows are full of wildflowers and the streams run fast with snowmelt. Independent hikers can camp in the valley; for the higher routes, a local guide is sensible given the terrain and the speed with which weather can change in the Greater Caucasus.
