...
The hike starts from the village and follows marked trails through forest before emerging on the open ridge. In summer the route is busy with local walkers; in autumn it's excellent, with clear air and the beech forests turning gold. Winter closes the trail after snowfall.

The monastery is visible directly below from the summit, which gives a clear sense of how dramatically oversized the baroque dome is relative to the tiny valley settlement around it.
