...
Go in expecting the spectacle it is: noisy, crowded, and improbably fun if you're in the right mood. Order the Weisswurst before noon (the Bavarian convention dictates they should never be eaten after the church bells have rung midday), eat the pretzels, and drink the Märzen. Locals do come — Munich residents have a complicated relationship with the place but some of them show up anyway, especially in the quieter upstairs rooms.
