...
latitude: 48.5770
longitude: 13.4647
snippet: "A medieval citadel above the old town with panoramic views of the three rivers meeting below"
story: >
...
Today it houses the Passau City Museum, which covers the city's history from Roman times through the episcopal era to the present. The collection is substantial and well-presented. But the main draw is the view from the citadel walls: the confluence of the Danube, Inn, and Ilz rivers is visible below in one panoramic sweep, each river running a different colour — the blue-green Danube, the darker Inn, and the small black Ilz. It is the definitive view of Passau and worth the climb for that alone.
