...
The park is less polished than Sanssouci but more genuinely local: families, joggers, and cyclists using it the way a city park should be used. It is a good destination on a Sunday afternoon when the royal parks are at their most crowded, and the treetop walkway provides a perspective on the landscape that no amount of ground-level walking can match.
