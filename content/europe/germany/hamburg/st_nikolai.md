...
A glass lift inside the spire takes visitors to a 76-metre viewing platform with panoramic views over Hamburg and the harbour — and a sobering perspective on the scale of the 1943 destruction visible from above. The crypt below the spire houses a small museum on the firebombing of Hamburg and the church's history. Closed Mondays.
