...
Public access to the building is limited, but the surrounding site is freely walkable, and the cantilevered glass facade is best seen from across the river on the south bank. Of particular note is the small memorial inside the perimeter to the more than 10,000 Jews deported from this same Grossmarkthalle in 1941–45 — a deliberately understated reminder built into the bank's reconstruction. Combine with a walk along the Ostpark, the green belt that begins behind the ECB.
