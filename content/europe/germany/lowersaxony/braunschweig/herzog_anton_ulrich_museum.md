...
The applied arts and decorative arts collections — ivory carvings, porcelain, Baroque silver — are equally distinguished and often overlooked by visitors focused on the paintings. The museum building is itself handsome: a 19th-century Italianate palazzo set back from the road in a small park east of the old town. Allow at least two hours; the combination of great paintings in manageable quantity and well-laid-out rooms makes it one of the more satisfying museum experiences in Lower Saxony. Closed Mondays.
