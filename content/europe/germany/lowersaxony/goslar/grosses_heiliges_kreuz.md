...
latitude: 51.9050
longitude: 10.4275
snippet: Medieval hospice and almshouse, still housing artists' studios five hundred years on.
tags:
- things_to_do
- sight
...
Walk into the courtyard — entry is free during the day — and you find a working artists' colony. Goldsmiths, ceramicists, and printmakers rent the upper-floor rooms from the foundation that still administers the property, and most are open to visitors when their lights are on. The cumulative effect is one of the more surprising corners of Goslar.
