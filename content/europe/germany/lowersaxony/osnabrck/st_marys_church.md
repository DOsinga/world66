...
Inside, the church is a tall, light space with the characteristic proportions of the north German Gothic hall church — nave and aisles at the same height, which floods the interior with light rather than creating the dark corridors of earlier Romanesque buildings. The notable feature is the astronomical clock on the south wall, a late medieval instrument that shows the phases of the moon, the calendar, and the position of the sun in the zodiac alongside the time. It still functions and is worth a close look.
