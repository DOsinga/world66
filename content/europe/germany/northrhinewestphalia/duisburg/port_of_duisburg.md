---
title: Port of Duisburg (Duisport)
type: poi
tags:
  - things_to_do
  - sight
...
For visitors, the port itself is an industrial working environment rather than a sightseeing attraction, but the scale and importance of what Duisburg does here is worth understanding as context for the city. Guided tours of the port can be arranged through Duisport's visitor programme. The view of the port from the Duisburg Rhine promenade — particularly the section near the Rhine confluence — gives a sense of its extraordinary scale.
