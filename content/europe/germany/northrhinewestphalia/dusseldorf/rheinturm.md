...
The tower is worth visiting for the views and for the curiosity of the binary clock — a column of pulse diodes on the shaft that displays the time in binary code. A diagram in the lift explains the system. The revolving restaurant completes a full rotation every hour and, while the food is not the main event, the setting makes it a memorable dinner option.
