---
latitude: 51.05277777777778
longitude: 13.739166666666666
tags:
- things_to_do
- sight
...
The procession shows 35 margraves, electors, and kings on horseback, along with artists, craftsmen, and scholars. Augustus the Strong appears near the end of the sequence, larger than the others. The surrounding figures include miners, farmers, and artisans intended to represent the productive base on which the dynasty's wealth rested. Looking at it from Augustusstrasse at night, when the city is quiet and the gold lettering catches the streetlights, is one of the genuinely memorable experiences Dresden offers.
