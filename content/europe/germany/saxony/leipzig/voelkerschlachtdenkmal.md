...
Inside, the lower crypt contains massive stone warrior figures in a brooding, low-lit chamber — the effect is somewhere between a medieval catacomb and a nationalist fantasy. A lift takes you to the dome platform, with views across the flat Leipzig plain that give you some sense of what 600,000 soldiers spread across this landscape must have looked like. The tram ride south from the city centre takes about 20 minutes; a small lake flanks the path to the monument and makes a good foreground for photographs.
