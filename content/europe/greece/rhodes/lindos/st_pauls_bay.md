...
The bay has a small sandy beach, sunbeds for hire, and a beach bar. It tends to be less crowded than the main Lindos beach to the north because the approach is less straightforward — a path leads down from the village, about 10 minutes on foot. The chapel (usually locked, visible from outside) is worth the extra few minutes to see from close range.
