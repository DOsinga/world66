...
In practical terms, this means motorboats are banned in the inner bay, beaches in the most sensitive zones close at sunset, and only licensed operators are permitted to run turtle-watching trips. The park's information centre at Gerakas on the eastern side of the bay is the best place to start if you want a sense of the science behind the rules — the displays are good and admission is free.
