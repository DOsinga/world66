...
The menu is built around the langoustine in various forms — grilled tails, soup, pasta — with some lamb and fish options for those who are inexplicably not here for the lobster. Service can be slow in peak season when the Ring Road traffic pushes the kitchen hard; this is not the place to come if you are trying to make a tight connection.
