---
title: Glacier Hikes on Vatnajökull
type: poi
latitude: 64.4167
longitude: -15.5833
tags:
...
The ice is not static. Vatnajökull is retreating under climate change and the surface is visibly different from year to year — a fact that makes these trips feel urgent as well as spectacular. The blue and white ice, the moulins dropping into dark shafts, and the occasional crack of calving ice overhead give the glacier a living presence that photographs do not capture. Book with a reputable operator (there are several based in Höfn) and go early in the day when the ice is firmest.
