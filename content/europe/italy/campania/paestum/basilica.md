...
Fifty columns surround the structure — nine across each short end, eighteen along each long side — which gives it an unusually wide double-nave plan inside. The roof is long gone, but the stone grid of the outer colonnade survives. Standing at the corner where the Basilica meets the Temple of Neptune, you can compare the two buildings directly: the visual difference between Archaic and Classical Greek architecture is immediate and striking.
