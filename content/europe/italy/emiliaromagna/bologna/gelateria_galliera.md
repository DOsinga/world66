...
Order *al bicchiere* (in a cup) or *al cono* (cone), pick two or three flavours, and add the panna (whipped cream) — it's free and made on the premises. Piazza Cavour, the small square the shop sits on, is a quieter spot to eat than the busy zone around the Two Towers.
