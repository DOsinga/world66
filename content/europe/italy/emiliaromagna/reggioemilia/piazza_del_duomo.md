...
The cathedral itself — the Cattedrale di Santa Maria Assunta — was begun in the late Roman period and reworked through the Romanesque, Gothic, and Baroque eras. The facade is an intriguing mix of architectural periods, but the interior is worth lingering in for its carved choir stalls and the crypt beneath the high altar. The detached Baptistery, rarely seen from the inside, has some fine Lombard stonework on its exterior.
