---
title: Balestrino Ghost Village
type: poi
tags:
  - things_to_do
  - sight
...
Guided tours of the ghost village run in the warmer months and are the only way to enter legally. The narrow lanes, the abandoned church of Sant'Andrea with its carved portal, and the views across the Riviera delle Palme below create a genuinely atmospheric experience. The contrast with the inhabited upper village and the castle just above is remarkable — two centuries of settlement sitting one above the other, one lived-in and one frozen in time.
