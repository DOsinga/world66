...
latitude: 43.8796
longitude: 7.8698
snippet: Baroque cathedral on Porto Maurizio's headland with views across the coast
tags:
- things_to_do
- sight
- church
...
The cathedral replaced an earlier Romanesque church that stood on the same site, some traces of which are visible in the lower walls. It's freely accessible during the day and is still used as the main parish church for Porto Maurizio. The area around it — within the Parasio quarter — is the quietest part of the old town.
