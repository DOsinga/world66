...
latitude: 44.3560
longitude: 8.2600
snippet: Ancient rock engravings on the hills above the village
tags:
  - things_to_do
  - sight
  - hiking
...
The carvings are accessible on foot from the village via the ridge trails. No formal signage exists, and a local guide or the municipal office can point you toward the most accessible sites. The walk up to the ridgeline takes about an hour and rewards with views across both Bormida valleys and, on clear days, to the Alpine chain to the north and the Ligurian Apennines to the south.
