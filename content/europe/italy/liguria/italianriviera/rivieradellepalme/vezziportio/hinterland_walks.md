...
The terrain is mixed: abandoned terraces covered in maquis scrub, patches of Mediterranean forest, and open limestone ridges. The trails are not heavily used by tourists — most walkers in this area gravitate to the better-publicised routes around Finale Ligure — which makes them pleasant for those who prefer quiet. A map from the local comune or from the CAI (Club Alpino Italiano) office in Savona is useful for anything beyond the obvious paths.
