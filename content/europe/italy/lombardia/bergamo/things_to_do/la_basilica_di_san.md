...
Inside: Lorenzo Lotto frescoes, extraordinary inlaid wood panels at the altar (ask the custodian to lift the covers), carved confessionals by Andrea Fantoni, and a famous organ. Don't miss the medieval iron measuring bars embedded in the outer wall — used in the open market days before standard units existed.
