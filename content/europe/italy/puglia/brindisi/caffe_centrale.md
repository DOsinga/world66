...
The espresso is excellent. The bar also does a strong line in Pugliese pastries — pasticciotto filled with custard cream, and taralli covered in sugar glaze. In the evenings it transforms into an aperitivo spot: the Aperol spritz is fine, but the better choice is an amaro or one of the local digestivi made with herbs from the Salento. Prices are thoroughly reasonable.
