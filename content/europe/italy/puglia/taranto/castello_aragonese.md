...
The castle is still an active Italian Navy installation, which means visits are by guided tour only and there are days when access is restricted altogether. The interior is less spectacular than the exterior warrants, but the views from the battlements across both the Mar Grande and the Mar Piccolo give you a sense of why this particular point was fortified in the first place — it controls everything entering or leaving the sheltered inner sea. The drawbridge, moat, and entry gate remain in their medieval configuration.
