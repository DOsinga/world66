---
title: Roccia dell'Elefante (Elephant Rock)
type: poi
tags:
  - things_to_do
  - sight
latitude: 40.8897
longitude: 8.7462
snippet: A volcanic boulder shaped like an elephant, with two Neolithic tombs carved inside it
story: >
  The two tombs inside the Elephant Rock are domus de janas — literally "houses of fairies" in
  Sardinian, though they are in reality Neolithic burial chambers carved into rock between 4000
...
The tombs are small and you can see the carved chambers without entering them. The site is signposted from the road and requires only a short walk. Given its proximity to Castelsardo, it is easy to combine with a town visit on the way to or from Sassari.
