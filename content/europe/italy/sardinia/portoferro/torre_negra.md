...
longitude: 8.1931
story: >
  Torre Negra was one of around 100 coastal watchtowers built by the Spanish Crown along
...
Torre Negra was built in the 16th century as part of the Spanish coastal defence network, a chain of towers designed to give early warning of corsair attacks. The name ("Black Tower") comes from the dark local stone used in its construction, which gives it a distinctly different appearance from the lighter limestone towers found elsewhere on the island. You can walk around its base and peer through the entry arch, though the interior is not accessible.
