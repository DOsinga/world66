...
image_source: https://commons.wikimedia.org/wiki/File:Etna_eruption_seen_from_the_International_Space_Station.jpg
...
The two main approach points are Rifugio Sapienza on the southern side (cable car, plus jeep and walking up to the central craters) and Piano Provenzana on the northern side (less developed, often quieter, can be combined with the Alcantara Gorges). Half-day organised tours run from Catania throughout the year. Conditions and access change with each eruption, so check with the local guides on the day.
