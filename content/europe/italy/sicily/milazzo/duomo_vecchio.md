---
title: Duomo Vecchio (Santa Maria Maggiore)
type: poi
tags:
  - things_to_do
  - sight
...
The setting is extraordinary — a baroque cathedral shell inside a medieval fortress, ringed by the old citadel buildings. It is one of those places that is more interesting for being partially ruined than it would be if fully restored. Check for current access as conservation projects can affect opening hours.
