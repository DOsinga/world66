...
The building is now used for civic functions and is not always open to the public, but when the courtyard gate is unlocked it is worth stepping in. The collection of coats of arms covering the courtyard walls — some in terracotta, some in painted stone — gives the enclosed space an unusually personal character. The exterior loggia at ground level faces the piazza and forms part of the medieval streetscape that makes this square so appealing.
