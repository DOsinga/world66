...
Inside, the cathedral is richly decorated despite the exterior austerity. The Chapel of the Holy Ring (Cappella del Santo Anello) holds a relic claimed to be the wedding ring of the Virgin Mary — a claim that has attracted pilgrims since the 15th century, when a group of Perugians stole it from a church in Chiusi. The ring is kept in a box with 15 locks, each with a different key held by a different official.
