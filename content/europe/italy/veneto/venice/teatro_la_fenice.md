...
The theatre is hidden in a dense block of the San Marco sestiere, reachable only on foot through a sequence of small alleys, which adds to the sense of occasion when you arrive. Guided daytime tours allow visitors into the auditorium when no performance is scheduled — well worth doing if tickets for an evening performance are not available. The opera season runs October through June. Book tickets early.