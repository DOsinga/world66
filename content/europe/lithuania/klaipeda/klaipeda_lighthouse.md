...
The lighthouse is a good orientation point: from its base you can see the full width of the strait, the city on one side and the Curonian Spit extending south on the other. The area around the lighthouse, with its sandy shore and pine trees, is a pleasant walk from the Lithuanian Sea Museum. The lighthouse itself is not open to visitors internally, but the exterior and surroundings are freely accessible.
