---
title: "Monastery of the Holy Fifteen Martyrs of Tiberiopolis"
type: poi
tags:
  - things_to_do
  - sight
...
The present monastery church is a small modern building, but the setting — old pines, mountain views, a stream running through the grounds — is the reason to come. The walk up from town passes the city park and the start of the path to the fortress, so the two visits can be conveniently combined.
