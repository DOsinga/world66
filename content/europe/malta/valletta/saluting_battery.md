...
type: poi
snippet: "Daily noon cannon below the Upper Barrakka, a two-century tradition"
tags:
  - things_to_do
  - sight
latitude: 35.8951
longitude: 14.5072
story: >
  The noon cannon has been fired daily from this battery since the British period, when it
  was used to allow ships in the Grand Harbour to synchronise their chronometers. The
...
Guided tours of the battery are offered morning and afternoon and include a history of the fortifications and a demonstration of cannon-loading and firing. The position inside the bastion walls gives a close-up view of the construction that is impossible to appreciate from above. This is one of the most satisfying short visits in Valletta.
