...
A small museum near the visitor centre displays artefacts from the various occupation periods — Dacian ceramics, Mongol-era metalwork, and medieval Christian objects. The explanatory panels are in Romanian and English. Combined with the cave monastery and the canyon views, the archaeological remains transform what might otherwise be just a scenic spot into one of the most layered and interesting sites in the entire country.
