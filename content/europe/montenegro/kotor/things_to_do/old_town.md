...
Allow an hour to wander freely; an extra hour if you stop in the cathedral and the Maritime Museum. The old town has three gates — the Sea Gate (the main entrance from the waterfront), the North Gate, and the River Gate — all worth looking at for the carved inscriptions and reliefs.
