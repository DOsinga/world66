...
The sculpture holds the same post in a purely symbolic sense. The gate survives; the function it served is long gone. The Wachter watches over an entrance that no longer controls anything, which gives the piece an elegiac quality the title alone doesn't prepare you for.
