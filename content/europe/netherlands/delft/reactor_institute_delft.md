...
The institute organises public open days and tours, typically once or twice a year, where visitors can see the reactor hall (the characteristic blue Cherenkov radiation glow from the reactor core being the highlight). Check the TU Delft website for the schedule. For non-science audiences, the combination of the university campus architecture and the improbable presence of a nuclear facility makes for an interesting diversion from the canal and ceramic focus of the rest of the city.
