---
title: Koningshoeven Abbey & La Trappe Brewery
type: poi
tags:
  - things_to_do
  - sight
latitude: 51.5435
longitude: 5.1266
snippet: The only Dutch Trappist brewery, founded by monks in 1884
story: >
  La Trappe is one of fewer than fifteen certified Authentic Trappist Products beers in the
  world. The Trappist label is controlled by the International Trappist Association and can only
...
The range runs from a blonde Witte and a hoppy Puur to the heavier Quadrupel and the barrel-aged Isid'Or. The abbey shop also sells the monks' own cheese and other products. The grounds are quiet, green, and well worth a half-afternoon if you are cycling east from Tilburg — the abbey is on a good bike route through the flat Brabant countryside.
