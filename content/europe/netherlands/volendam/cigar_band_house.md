...
This is still a private residence, so the viewing is from the street only. The bands were collected over many years from neighbours and tobacco shops across the Netherlands, and there is something satisfying about the logic of it: the most abundant waste material of the era transformed, with patience and care, into a permanent local landmark.
