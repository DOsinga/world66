...
Several operators run **seal-spotting boat trips** from the harbour during the summer, typically a two-hour cruise to a sandbank when the tide allows. The smaller operators using flat-bottomed Wadden-Sea schooners get closer than the bigger excursion boats. Pup season (late spring for harbour, winter for greys) is when the chances are highest of seeing newly-born animals.
