...
Race weekends — particularly the Grand Prix — book out the entire town and turn the trains orange. Outside race days the circuit runs guided tours, trackday rentals, and a small museum; you can also walk the dunes immediately alongside on public paths in the national park. The grandstands are still grassed earth banks for the most part, which gives the circuit a much more old-fashioned feel than any other F1 venue.
