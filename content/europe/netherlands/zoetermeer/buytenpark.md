...
The park is deliberately low-key — this is a place for a Sunday stroll or an afternoon on a bicycle, not a destination in itself. The surrounding polders are genuinely beautiful in spring, when the fields are brilliant with tulips and the ditches run full, and in winter when the water freezes. The cycling infrastructure connecting Buytenpark to the wider Green Heart of Holland is excellent.
