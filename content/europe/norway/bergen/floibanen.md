...
At the top there is a restaurant, a playground, and the start of several well-marked hiking trails through the birch forest. The most popular descent is on foot — the path down through the woods takes about 45 minutes and passes through quiet neighbourhoods on the way back to the centre. Locals use the funicular as daily transport, which keeps it honest.
