...
The UNESCO World Heritage designation (granted in 2005) reflects the arc's importance to the history of science: it was the first international scientific collaboration spanning multiple countries, and its measurements were accurate to within metres using only triangulation and the naked eye. The column itself is a modest stone obelisk that requires a short uphill walk — but the views over Hammerfest harbour and the surrounding fjord from the hillock are an excellent reason to make the climb regardless of the history.
