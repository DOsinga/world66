...
type: poi
snippet: "Crescent of white sand on the wild outer coast, reached only on foot from Fredvang"
story: >
  Kvalvika is unreachable by road and is one of the few large beaches in
  Norway with no permanent structures of any kind. It was the setting of the
...
The harder climb continues from the south end of the beach up to the summit of Ryten (543 m), with one of the great Lofoten views — the curve of the beach below, the open ocean to the west, and the chain of jagged peaks running back inland. Allow a full day for the round trip including the summit.
