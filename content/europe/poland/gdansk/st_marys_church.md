...
story: 'After 1945, the church''s famous astronomical clock — built in 1464 and capable
  of showing the day, month, year, moon phase, and the positions of the sun and moon
  — was removed by Soviet forces and taken to the National Museum. It was returned
  to the church only in 1983, after decades of diplomatic wrangling.

  '
snippet: World's largest brick church with 405-step tower views
tags:
- things_to_do
- landmark
