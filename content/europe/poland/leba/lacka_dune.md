---
title: The Łącka Dune (Słowiński National Park)
type: poi
tags:
  - things_to_do
  - sight
...
The walk to the dune from Łeba takes around an hour on foot (or less by hired bicycle, available in town). The path follows the beach westward through the park, passing between the sea and Lake Łebsko. When you arrive at the dune, the landscape is genuinely surreal — bare white sand in all directions, broken only by the dead trunks of trees half-swallowed by the advance. Views from the crest stretch across the Baltic to the north and the lake to the south. Słowiński National Park is a UNESCO Biosphere Reserve; there is an entrance fee.
