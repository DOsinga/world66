...
The lean is the result of ground subsidence in the sandy soil near the Vistula rather than construction error, though local legend attributes it to the penance of a wayward Teutonic Knight. The tower is not open to climb but can be viewed and photographed from the small square below. It sits near the Monastery Gate, one of three surviving medieval city gates.
