...
longitude: 21.0284
score: 7.5
snippet: Hands-on science museum on the Vistula — one of the most visited attractions
  in Poland
sources:
...
The museum is designed for everyone, not just children — many exhibits are genuinely challenging for adults. The building itself is striking, designed to evoke a ship on the river. Book tickets in advance during school holidays when it gets crowded. The planetarium shows run separately and need separate booking.