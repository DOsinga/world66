...
The lighthouse was built in the 19th century but a tower has stood here since at least the 1520s. The small fort (Fort São Vicente) predates the lighthouse and can be explored on foot. A handful of vendors sell fish-based snacks and drinks from vans in the car park — a slightly absurd but practical concession to the crowds. The walk from the Sagres fortress along the coastal path takes about an hour each way and is one of the better hikes in the Algarve.
