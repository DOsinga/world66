...
The grilled horse mackerel (carapau grelhado) is a benchmark here — simple, fresh, and honest in the way that only works when the fish is genuinely good. The wine list leans on Portuguese regionality; the staff are helpful if you ask for guidance. This is the kind of place where lunch can extend well into the afternoon without anyone minding.
