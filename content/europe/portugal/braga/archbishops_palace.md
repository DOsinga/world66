...
longitude: -8.4262
sources:
  - https://en.wikipedia.org/wiki/Episcopal_Palace,_Braga
tags:
  - things_to_do
  - sight
  - architecture
...
The building now houses the University of Braga's rectorate, the public library (Biblioteca Pública de Braga), and the municipal archive — all open to visitors. The library's reading room, with its painted ceilings and rows of old volumes, is particularly worth seeking out. The exterior loggia overlooking the Garden of Santa Bárbara is one of the best vantage points in the centre.
