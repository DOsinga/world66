...
longitude: -8.4293
sources:
  - https://en.wikipedia.org/wiki/Arco_da_Porta_Nova
tags:
  - things_to_do
  - sight
  - architecture
...
The design is more restrained than much of the baroque work in the city — clean, proportioned, and well-suited to its role as a gateway. It is a natural starting point for a walk into the old centre.
