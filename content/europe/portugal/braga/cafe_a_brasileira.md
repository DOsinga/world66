...
longitude: -8.4235
sources:
  - https://en.wikipedia.org/wiki/Caf%C3%A9_A_Brasileira_(Braga)
tags:
  - bars_and_cafes
  - bar
  - cafe
...
Not to be confused with the more famous A Brasileira in Lisbon's Chiado, though both share the same Brazilian-coffee-import origins. This one is quieter, less touristy, and an honest picture of a Portuguese café that has not been refurbished into something photogenic.
