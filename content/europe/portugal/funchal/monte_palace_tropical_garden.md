...
The route winds up and down through different climate zones, and the views from the upper terraces back down to Funchal and the harbor are worth the visit on their own. Allow at least two hours — more if you intend to see the museum collections. The garden can be combined with a visit to the Madeira Botanical Garden; a cable car connects the two sites, making it possible to see both in an afternoon.
