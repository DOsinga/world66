---
title: "Sanctuary of Our Lady of Nazaré"
type: poi
tags:
  - things_to_do
  - sight
...
longitude: -9.0767
story: >
  The legend behind the sanctuary involves a 12th-century Portuguese nobleman, Dom Fuas
  Roupinho, whose horse was about to plunge over the cliff during a fog while chasing a
...
The sanctuary is an active pilgrimage site, especially around September 8th (the feast of Our Lady of Nazaré), when processions fill the clifftop square. The atmosphere is notably different from a standard tourist church — people come here to pray, not just to look.
