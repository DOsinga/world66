---
title: "Church of São Salvador (Bravães)"
type: poi
tags:
  - things_to_do
  - sight
...
The north portal is almost as elaborate, with a sculpted Lamb of God on its tympanum. Inside, the building is plain — a single nave, a small rectangular chancel, an aged wooden ceiling — but the contrast with the dense exterior carving is part of the effect. Visiting hours are restricted; the key is held at the Junta de Freguesia in Bravães and the church is normally only open on Sundays and by appointment, but if the door is locked the carved exterior alone repays the short drive.
