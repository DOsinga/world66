...
The sanctuary was founded in the late thirteenth century, when an image of the Virgin was reportedly discovered here; the current Baroque church dates from the eighteenth century, when the cape was one of the most visited pilgrimage sites in Portugal. The pilgrim lodgings — two long, low arcaded buildings flanking the church — held the confraternities that came each September, and most are still standing if increasingly derelict. The cliff path leads to the dinosaur footprints (see story below) and the small Ermida da Memória chapel on the cliff edge. Bring a windproof; it is exposed.
