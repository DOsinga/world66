---
title: "Muzeul Petrolului (Oil Museum)"
type: poi
tags:
  - things_to_do
  - museum
...
Romania was genuinely a pioneer in the petroleum business — one of the first countries to refine crude oil commercially and to use oil lamps at scale — and the museum makes this case effectively. The connection to World War II is unavoidable: the refineries made Ploiești one of the most heavily bombed cities in Europe, and Operation Tidal Wave (1943), in which the USAAF attacked from low altitude with catastrophic losses on both sides, is covered in some detail. The museum is close to the Clock Museum and can easily be visited on the same trip.
