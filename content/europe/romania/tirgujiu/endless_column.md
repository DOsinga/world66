...
tags:
  ...
  - sight
  - museum
snippet: "Brâncuși's 29-metre cast-iron masterwork, the tallest point in the Calea Eroilor ensemble"
latitude: 45.0392
longitude: 23.2839
...
The 17 full modules and two half-modules at the base and top were cast in Petroșani and assembled on site. The proportions are exactly calculated so that the column appears to extend infinitely upward, as if it could stack forever into the sky. Stand close and the effect is vertiginous. Move back and the whole axis of the ensemble — Gate, Alley, Column — resolves into a single coherent gesture.
