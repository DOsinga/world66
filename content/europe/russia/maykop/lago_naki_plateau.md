...
The plateau is at its best in summer (June–September), when the meadows are in flower and the hiking is straightforward. Marked trails range from easy plateau walks to more demanding routes into the surrounding mountains. The Azish-Tau cave complex on the edge of the plateau is worth an hour — it has stalactites and stalagmites in a limestone cave that can be visited on a guided tour without serious caving experience.

In winter the plateau sees enough snow for cross-country skiing, though facilities are basic. Getting to Lago-Naki requires either a car or an organised tour from Maykop; there is no public transport to the plateau itself.
