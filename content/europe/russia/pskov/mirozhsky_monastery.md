...
The paintings are extraordinary. The style is distinctly Byzantine — flat, golden, formally composed — but with a character that feels specifically Pskovian: earthy, intense, and completely unlike the more exuberant style of later Russian icon painting. The monastery also has a small museum of Pskovian art and a few other historic structures within its walls. Allow an hour and a half for a proper visit.
