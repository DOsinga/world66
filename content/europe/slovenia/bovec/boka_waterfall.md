...
The path to the viewing platform winds along the cliff edge and is well maintained, though the final section involves some fixed rope climbing. The falls reduce significantly in late summer but remain impressive. The Boka is one of the most rewarding short walks in the Soča valley, and can be combined with swimming in the Soča pools below.
