...
The Madagascar section is the highlight, with ring-tailed lemurs, fossa, and aye-ayes in dense planted enclosures. The gorilla habitat is excellent, and the pygmy hippo pool allows underwater viewing. There is a daily programme of presentations (not performances — the animals are not made to perform) and guided feeding times. Allow three to four hours. The park is compact and air-conditioned in key areas, making it viable even in the height of summer. It is in the centre of Fuengirola, an easy walk or taxi from the seafront.
