...
You can walk the battlements, climb the keep for the view (one of the best in Andalusia — a green sea of olive trees rolling to every horizon), and visit the small interpretation centre. The castle is now attached to the Parador de Jaén, one of Spain's state-run hotels, where you can go for a drink even if you are not staying.
