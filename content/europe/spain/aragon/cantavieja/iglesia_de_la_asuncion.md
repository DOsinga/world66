...
The bell tower — square, solid, and visible from the surrounding countryside for a considerable distance — serves as the main vertical landmark of the village. Access to the church is variable; if it is locked, ask at the TIC on the plaza, which can usually arrange entry. The church is the focal point of Cantavieja's main festival, the Feast of the Assumption, held in mid-August, when the village fills well beyond its usual quiet.
