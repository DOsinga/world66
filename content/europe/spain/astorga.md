...
The city has been a stopping point for pilgrims for over a thousand years, and there's a quiet pride in that history. Astorga is also the heartland of Maragato culture — a distinct ethnic and culinary tradition. The local speciality is the cocido maragato, a hearty stew of chickpeas, vegetables, and meats served in reverse order (meat first, soup last), which is unusual and worth trying.
