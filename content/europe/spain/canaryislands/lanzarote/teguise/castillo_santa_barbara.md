...
Inside, the castle now houses the **Museo de la Piratería** — the Museum of Piracy — a small but well-presented collection telling the long story of corsair raids on the Canary Islands. There are maps, weapons, model ships, and rooms set up to evoke prison cells and powder magazines. Allow about an hour. The road up is steep and unpaved in places; a regular car will manage it in dry weather, but a 4×4 or a determined walk is a better idea.
