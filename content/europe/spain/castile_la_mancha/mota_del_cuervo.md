...
image_source: https://commons.wikimedia.org/wiki/File:Horno_alfarero_de_Mota_del_Cuervo_(Cuenca_-_1968).jpg
latitude: 39.500934
loc_type: city
longitude: -2.871109
score: 6.91
...
The windmills date to the 18th century. Three are open to visit. El Gigante, rebuilt in 1967, functions as a milling museum with working machinery; on Saturday mornings staff grind flour the old way. Look for El Zurdo — it's the one whose sails turn counterclockwise, which is unusual enough to have earned it a nickname (zurdo means left-handed). The view from the ridge at dusk is worth the climb on its own.
...
Belmonte, 15 km west, has one of the best-preserved castles in Castilla — a Gothic-Mudéjar fortress from 1456 that you can walk through properly, not just photograph from outside. [Campo de Criptana](/europe/spain/castile_la_mancha/campo_de_criptana), with its own cluster of windmills, is 30 km to the southwest. Either makes a natural combination with a stop here.
