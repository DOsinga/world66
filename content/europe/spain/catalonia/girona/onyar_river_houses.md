...
latitude: 41.9860
longitude: 2.8230
snippet: Girona's postcard image — colourful houses perched above the Onyar River
tags:
- things_to_do
- sight
...
The houses are private residences, not tourist attractions — they are best photographed from the opposite bank, especially in the late afternoon when the light is on the facades. Walking the path along the east bank of the river at different hours shows how dramatically the colour changes with the light.
