...
The museum also covers the pre-Roman and medieval phases of Alcalá's history, placing the Roman city in the longer sequence of human settlement in the Henares valley. The building itself, with its courtyard and colonial-era architecture, is worth seeing. The museum is a short walk from the university and the Cervantes birthplace, and pairs well with a visit to the Roman forum site outside town.
