...
latitude: 38.8819
longitude: -6.9714
snippet: Octagonal Almohad watchtower crowning the Alcazaba
tags:
- things_to_do
- sight
- architecture
...
The name — literally 'dog-scarer' — comes from the bell that once hung in the upper chamber, used to summon the city's defenders. It can be climbed on weekends for views over the rooftops, the Guadiana valley and across to Portugal.
