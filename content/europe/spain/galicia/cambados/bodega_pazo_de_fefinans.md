---
title: "Bodegas del Pazo de Fefiñáns"
type: poi
tags:
  - things_to_do
  - sight
...
Visits can be arranged to see the cellars and the production facility, which occupy the old stone rooms of the pazo and have a satisfying sense of continuity with the building's history. Tastings are available and the wines can be purchased directly. Even if you don't tour the bodega itself, the shop on the square is worth a stop — you'll pay close to bodega prices and leave with a better bottle than you would from most wine shops.
