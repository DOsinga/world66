...
longitude: -0.9837
sources:
  - https://en.wikipedia.org/wiki/Basilica_of_Nuestra_Se%C3%B1ora_de_la_Caridad,_Cartagena
tags:
  - things_to_do
  - sight
  - architecture
...
Step inside if the doors are open, especially on a hot afternoon. The church gives a useful pause between the Roman sites and the modernist streets, and it remains important to cartageneros in a way that visitors can easily miss.
