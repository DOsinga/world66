---
title: "International Bagpipe Museum"
type: poi
tags:
  - things_to_do
  - museum
...
The museum makes a convincing case that the bagpipe, far from being a specifically Celtic instrument, is among the most geographically widespread woodwind instruments in the world — found from Ireland to India, with different constructions and different sounds in each tradition. Even for visitors with no prior interest in the instrument, the breadth of the collection is genuinely surprising. The museum sits within the same park as the Museo del Pueblo de Asturias and can be visited on the same ticket; the combined visit takes about two hours. In summer, the park sometimes hosts live gaita performances.
