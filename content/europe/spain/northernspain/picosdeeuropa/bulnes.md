...
From Bulnes, the walking routes into the heart of the Central Massif begin immediately. The path to the Vega Urriellu (base camp for Naranjo de Bulnes) takes about 3 hours. Routes toward the Pandébano pass and on to Sotres are also accessible. Bulnes is split between Bulnes de Abajo (Lower Bulnes, where the funicular exits) and Bulnes de Arriba (Upper Bulnes, a ten-minute walk higher). Staying a night here — in a casita rural — gives you the mountains after the day visitors have gone.
