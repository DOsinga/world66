---
title: Cares Gorge (Ruta del Cares)
type: poi
tags:
  - things_to_do
  - nature
...
The route is technically straightforward — no technical equipment needed, no serious scrambling — but the exposure is significant at several points, and the path narrows to less than a metre in places where it is cut directly into the vertical rock face. The most challenging aspect is the sheer number of other hikers in summer. The gorge is genuinely best done in May, June, September, or October, when crowd levels are manageable and the light is not as harsh. Allow 4–5 hours for the full traverse (one direction). Transport between the two trailheads requires advance planning — taxis and buses serve the area in summer.
