...
Beyond the signature rice, the menu is straightforwardly regional: grilled rabbit, salt cod preparations, and the various vegetable dishes typical of this part of the Valencian Community. The wine list leans into local Alicante DO bottles, which is the right call. Book ahead for weekend lunches, when the restaurant fills with local families and the wait for a table without a reservation can be long.
