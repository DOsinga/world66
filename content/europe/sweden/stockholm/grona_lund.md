...
The park also functions as a major concert venue, with big-name acts performing on the outdoor stage throughout summer. The setting — with the waterfront, Djurgården's trees, and the Stockholm skyline visible — is one of the nicer places in the city to see live music. The park is open seasonally from spring through autumn.
