---
title: Holzbrücke (Covered Wooden Bridge)
type: poi
tags:
  - things_to_do
  - sight
...
longitude: 8.3328
story: >
  Floods on the Reuss have destroyed Bremgarten's bridge at least nine
  times since the thirteenth century. The current structure, finished
...
The bridge is open to pedestrians and cyclists; cars use the modern bridge alongside. Walk it twice, once each way — the upstream views and the views back at the old town are quite different. Two small painted chapels are set into the bridge mid-span, dating from the seventeenth century.
