...
latitude: 46.2003
longitude: 6.1456
snippet: Geneva's monumental tribute to the Protestant Reformation and its leaders
tags:
  - things_to_do
  - sight
  - monument
story: >
  The four central figures depicted on the wall — Calvin, Farel, Beza, and Knox
  — are all rendered at precisely 4.5 metres tall, which may seem modest for
  heroes of a world-historical movement. But the sculptors deliberately kept
...
The park around the wall is pleasant and free to enter, with large chess boards on the lawn where games are often in progress on fine days. The Geneva motto carved into the wall — "Post Tenebras Lux" (After Darkness, Light) — gives the Reformation's self-understanding in three words. The park connects to Place Neuve, just north, which has the Grand Théâtre, the Conservatoire, and the Musée Rath around its edges.
