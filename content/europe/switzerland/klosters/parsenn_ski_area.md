...
The area is notable for its variety — wide open cruising runs on the upper plateau, steeper couloirs on the northern faces, and the long valley runs back down to Klosters and the satellite village of Wolfgang. The lift system connects seamlessly to the full Davos network, making the Davos–Klosters area one of the ten largest ski domains in the Alps. For those staying in the quieter atmosphere of Klosters, the Parsenn gives access to the full scale of the mountain without needing to base in Davos itself.
