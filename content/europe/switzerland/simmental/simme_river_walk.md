...
The most attractive section is between Erlenbach and Zweisimmen, where the valley is wide enough for the river to meander and the farmland on either bank is open. The stretch between Boltigen and Weissenburg passes through a narrow gorge section — the Simmenfluh — where the river cuts through a limestone ridge and the path briefly climbs above the water.

The route is equally good for cycling; the valley-floor gradient is gentle enough that the whole length can be ridden in a single day on a standard bike. The path uses no major roads and the surface is a mix of gravel and asphalt. Most trailheads have bike racks.
