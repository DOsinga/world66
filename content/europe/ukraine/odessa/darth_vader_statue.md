...
latitude: 46.4787
longitude: 30.7259
snippet: A Lenin monument transformed into the most famous Sith Lord by local artists
tags:
- things_to_do
- sight
- art
title: Darth Vader Statue
type: poi
story: >
  When Ukraine passed the "decommunisation" law in 2015 requiring the removal of Soviet
  symbols, Odessa's citizens faced a choice about what to do with their Lenin statue.
...
The statue is functional as well as comic: it contains a Wi-Fi router, and a plaque on the base carries text from the Ukrainian constitution. It has become a surprisingly fitting emblem for a city that has always had a mordant sense of humour about power and authority.
