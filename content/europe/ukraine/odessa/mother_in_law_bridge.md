...
latitude: 46.4725
longitude: 30.7450
snippet: A pedestrian footbridge decorated with thousands of padlocks, with a view over the port
tags:
- things_to_do
- sight
...
The railing is now heavily encrusted with padlocks — the European couples' tradition arrived in Odessa with a vengeance — and the bridge has a slightly precarious, swaying quality that adds to the charm. It is a genuine Odessa peculiarity, worth the walk out to it.
