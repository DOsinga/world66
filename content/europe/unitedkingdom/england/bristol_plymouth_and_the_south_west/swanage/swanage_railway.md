...
Buy a Round Robin ticket if you want to combine the train with a bus to and from Wareham (mainline rail to London). A regular timetable runs from spring to autumn, with reduced winter services and special days year-round — check ahead. The station at Swanage itself is worth a look even if you don't take a train: original signal box, signage, and a small railway shop in the booking hall.
