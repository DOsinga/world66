...
The museum closed in 2018 for an ambitious multi-year restoration as part of the city's Maritime project, which also covers the Spurn Lightship and the Arctic Corsair trawler. Reopening dates have shifted several times — check the current status before visiting. When open, the building's interior is as much a draw as the collection: ornate plasterwork, mosaic floors, and a court room used by the dock company in its heyday.
