...
latitude: 51.133
longitude: 1.354
snippet: Iconic chalk cliffs with views across to France
tags:
- things_to_do
- landmark
...
The National Trust manages the cliff tops east of the port, with a visitor centre about 3 km from the town and a network of walking paths along the cliff edge. The most popular walk runs about 4 km from the visitor centre to the South Foreland Lighthouse, with views across to France throughout. The clifftop turf is rich in wildflowers in summer, and peregrine falcons hunt along the face. Come at low tide when the chalk ledges at the base are exposed and the colour contrast between rock, sea and sky is at its most dramatic.
