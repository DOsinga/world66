...
The Common has been protected from enclosure since the seventeenth century, when the Manor of Rusthall granted local freeholders rights that prevented developers from carving it up. The result is that the town has wild, open ground right at its centre — popular with walkers, dog-owners, climbers and the cricket teams who use Higher Common Ground at the southern end.
