...
latitude: 51.6933
longitude: -0.4197
snippet: The Making of Harry Potter — full-scale film sets, props and effects
story: >
  The Great Hall set at Leavesden is the original — the same Lancastrian
  stone-flagged floor used for the Sorting Hat ceremony in 2001 is what
...
The visit takes three to four hours. Highlights are the Great Hall, the full-scale Diagon Alley exterior, the 1:24 scale model of Hogwarts Castle (used for wide shots in the films), and the costume and creature workshop. Booking is essential — tickets sell out weeks in advance and there are no walk-ups. A shuttle bus runs from Watford Junction station on weekdays.
