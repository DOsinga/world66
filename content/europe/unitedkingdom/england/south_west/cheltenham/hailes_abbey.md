...
longitude: -1.928841
score: 7.0
snippet: Ruins of a medieval Cistercian abbey in the Cotswolds near Cheltenham.
sources:
...
The abbey works best as a Cotswold excursion rather than an urban Cheltenham sight. Pair it with Winchcombe, walking routes, or nearby churches, and let the quiet setting do some of the work; the ruins are more evocative when you give them time.
