...
latitude: 51.1462
longitude: -2.7098
snippet: 15th-century pilgrims' inn with a famously haunted Tudor facade
tags:
- bars_and_cafes
- bar
- architecture
...
The bar is dark, low-beamed, and atmospheric in the way only a 500-year-old English pub can be. The food is straightforward pub grub; the ale list runs to local Somerset breweries. Even if you don't eat, walk in for a half-pint and a look at the panelling.
