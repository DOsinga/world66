...
longitude: -2.9672
story: >
  Architect Kengo Kuma designed the building's twisted, fissured exterior
  to evoke a Scottish sea cliff. The 2,500 horizontal stone panels — each
  cast in concrete and weighing up to two tonnes — are angled so the facade
...
Temporary exhibitions are world-class and typically book up at peak times. Entry to the building and the Scottish Design Galleries is free; only the temporary exhibitions are ticketed. The cafe on the ground floor is good. Allow at least two hours, more if there is a major show on.
