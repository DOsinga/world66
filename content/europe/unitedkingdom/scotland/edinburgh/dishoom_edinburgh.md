...
Queues form before it opens on weekends; arrive when the doors open or book (only some tables can be reserved). The downstairs dining room is the most atmospheric. The cocktail menu is strong.