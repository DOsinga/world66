...
The park around the house is free to enter and pleasant for a walk, with a loch, formal gardens, and paths leading into the Callendar Woods. The woods contain the Antonine Wall, Rome's second frontier in Britain, which you can walk along here. The Forbes Mausoleum — an early 19th century structure now locked and atmospheric — is in the woods too, and worth finding if you enjoy a little carefully managed decay.
