...
For non-fishers, the riverside paths below the castle offer a pleasant walk through mixed woodland, particularly good in early summer when the wildflowers are out. The gorge above Gight is rougher and requires an OS map — the path is not maintained. Downstream, the Ythan broadens into an estuary near the coast at Newburgh, where it is one of the best places in Scotland to see grey seals.
