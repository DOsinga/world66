...
It is now a private residence and not normally open to the public, but the cliff path passes close to its boundary wall and the structure is striking against the empty horizon. Combine it with a walk along the South Wales Coast Path from Rest Bay — a flat hour's walk each way, with the Bristol Channel on your left and golf greens on your right.
