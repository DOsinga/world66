...
The reef dives cover coral walls, swim-throughs, and shark encounters (Caribbean reef sharks are common). The cave dives are appropriate for Advanced Open Water divers with cavern certification. PADI courses are available at all levels. The dolphin programme runs separately and can be booked without scuba certification as a snorkelling experience. All operations depart from the Port Lucaya dock. Book in advance, especially in high season.
