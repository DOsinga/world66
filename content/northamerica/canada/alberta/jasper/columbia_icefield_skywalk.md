...
latitude: 52.2167
longitude: -117.2167
story: The glass floor panels are 1.2 centimetres thick and rated to hold the weight
  of several vehicles, but none of that information is particularly calming when you
...
The Skywalk is a ticketed attraction operated alongside the Snocoach glacier tours, and the price is not trivial. Whether it justifies the cost depends on how you feel about heights and engineered viewpoints. But the views are genuinely extraordinary, and the walk along the cliff edge to reach it builds up the sense of exposure in a way that makes the final platform feel earned.
