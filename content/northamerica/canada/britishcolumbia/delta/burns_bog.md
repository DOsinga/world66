...
Access is via the Burns Bog Conservation Society's guided walks, which leave from the entry point on 72nd Street. Self-guided access is limited to protect the fragile peat surface. The guided tours are recommended anyway — the guides explain why the bog looks the way it does, and the ecology is genuinely unusual. Tours run on weekends; check the Conservation Society website for the current schedule.
