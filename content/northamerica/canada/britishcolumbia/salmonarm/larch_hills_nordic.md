...
In summer, the same network converts to mountain biking and hiking trails. The terrain is gentler than the more technical bike parks found elsewhere in BC, which makes it accessible to intermediate riders and families. The views from the higher trails take in Shuswap Lake and the valley below Salmon Arm. Access is via the Grandview Bench Road and Edgar Road — a gravel drive that requires a bit of navigation but is fine for any vehicle in dry conditions.
