---
title: Quidi Vidi Lake and Village
type: poi
tags:
  - things_to_do
  - sight
...
The lake is the venue for the Royal St. John's Regatta on the first Wednesday in August, the oldest continuous sporting event in North America. The brewery of the same name makes Quidi Vidi Iceberg Beer (brewed with actual iceberg water), which has become something of a Newfoundland souvenir. The walk around the lake takes about an hour and passes the village on the seaward side.
