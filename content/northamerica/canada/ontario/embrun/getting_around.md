...
A map of the town of Embrun can found at http://prescott-russell.on.ca/documents/alacarte/map_embrun.pdf (note: that file is a pdf file, so you need adobe acrobat reader to view it)**By car**
Getting around Embrun by car is easy. Most of the
town's tourist-related buildings and areas are accessible off the main
road, called Notre-Dame Street.
