...
The actual range light is still active. A small information board explains the history of the port, which once shipped grain, lumber and stone to the rest of the Great Lakes basin.
