...
For visitors, the main interest is the Sheridan Student Gallery, which shows graduating student work including animation, illustration, and design. The gallery is open to the public and provides a good window onto the kind of creative output the school produces. The college also runs a theatre program and presents productions in its Fleck Dance Theatre and other campus venues, some of which are open to the public.
