...
The reason to come is [Sentier des Caps de Charlevoix](/northamerica/canada/quebec/saint_tite_des_caps/sentier_des_caps_de_charlevoix), a trail network with river and Laurentian views in summer and serious snowshoeing or cross-country skiing in winter. The municipality also covers Sault-au-Cochon, a rougher forested area tied to both recreation and the 1949 air disaster that became one of Canada's darker aviation stories.

Saint-Tite-des-Caps is best treated as an outdoor stop, not a village sightseeing tour. Use it when you want a day on the trails between Québec City, Mont-Sainte-Anne, and Charlevoix.
