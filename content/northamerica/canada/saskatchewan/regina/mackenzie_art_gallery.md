...
The gallery mounts ambitious temporary exhibitions that rotate through major works from other Canadian and international collections. The travelling exhibitions can be significant — genuinely important shows that would not typically stop in Saskatchewan. Given that admission is by donation and the gallery is rarely crowded, it offers a better ratio of art quality to visitor density than most comparable institutions in larger cities. The café in the building has decent coffee and looks out toward the lake.
