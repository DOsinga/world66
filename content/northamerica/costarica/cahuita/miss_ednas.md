...
The setting is simple — a few tables in a no-frills dining room — and the service operates on Caribbean time, which means you should not be in a hurry. Order early if there is something specific you want: rondon in particular can run out. Miss Edna's is the right choice if you want to eat food that is genuinely rooted in this community rather than adapted for tourist palates. It is also one of the places where you can have a conversation about the village and where things are going, which is worth as much as the food.
