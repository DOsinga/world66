...
It has served different functions over the years — community centre, theatre, restaurant — and is occasionally closed between uses. Even from the outside it is worth a look for the Caribbean architecture: wooden boards, a steep tin roof, and the kind of upper-floor verandah that has all but disappeared from the rest of the country.
