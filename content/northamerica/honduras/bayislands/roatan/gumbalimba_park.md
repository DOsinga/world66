...
Beyond the animals there is a small **pirate-themed museum** (entertainingly random), a zip-line course over the canopy, a snorkelling lagoon, and a private beach with loungers. Half-day combo tickets are good value if you want to do more than one element; expect crowds when cruise ships are in port.
