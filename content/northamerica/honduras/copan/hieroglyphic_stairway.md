...
The stairway is covered by a modern protective roof, which does unfortunately reduce the dramatic impact of the setting, but also preserves the inscription against erosion. A long-term project to correctly re-read and reassemble the stairway has been ongoing for decades. The stairway faces west onto the Hieroglyphic Stairway Plaza, which is one of the more atmospheric spaces in the site, enclosed by mounds and monuments on three sides.
