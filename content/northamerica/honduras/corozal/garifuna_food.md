...
Garifuna cuisine is built around cassava, plantain, coconut, and fish, reflecting both the West African heritage and the Caribbean environment. The cassava is grated, pressed to remove its natural toxins, and dried before use — a process unchanged from what the Garifuna brought with them from the islands. Eating here is a genuine encounter with a living food tradition.
