...
Local rules allow snorkelling but not scuba diving with the sharks, and operators are supposed to limit numbers in the water at one time. Pick a shop that takes the rules seriously — the Whale Shark and Oceanic Research Centre runs research-led trips and is the most reliable for an ethical encounter.
