---
title: Studio One (Brentford Road)
type: poi
tags:
  - things_to_do
  - sight
...
The Studio One label's archive — thousands of original recordings from the 1960s and 70s — has been partially digitised and continues to be reissued. The physical building on Brentford Road, which also served as Dodd's record shop, is recognisable and sits in a neighbourhood that has remained working-class and largely unchanged from the era when these sessions took place. Music history tours of Kingston typically include this address alongside Channel One and the Reid's Records area as the core of Kingston's recording history geography.
