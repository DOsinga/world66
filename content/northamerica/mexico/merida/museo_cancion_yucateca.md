...
The museum is modest in scale but genuine in its commitment to a local cultural form that deserves more attention than it gets. Staff are usually happy to play recordings, and if you are lucky you may catch a live trova performance in the small courtyard — the museum hosts them periodically. Prices are very low and the museum is worth an hour of anyone's time, particularly given how little coverage trova receives in most Mérida travel writing. It sits near the Ermita de Santa Isabel, which is itself worth a look for the archway and garden.
