...
latitude: 20.5800
longitude: -87.1200
snippet: "A large eco-archaeology park built around an ancient Maya harbour, with underground rivers and reef snorkelling"
story: >
...
The archaeological component is real: the ruins at the site are genuine Maya structures from the Polé trading port. The park also contains a re-creation of pre-Columbian and colonial Mexican life that ranges from earnest to spectacular depending on your tolerance for performance. Book in advance for the evening show, which draws large crowds. Ferry connections to Cozumel depart from inside the park.
