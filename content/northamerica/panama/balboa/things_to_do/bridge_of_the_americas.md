...
You can drive or walk across the bridge, though it's more of an infrastructure sight than a destination in itself. The view from the middle, looking north up the Canal's Pacific approach with ships moving in both directions, is good. The newer Centennial Bridge (2004) has taken most of the traffic, leaving the Bridge of the Americas somewhat quieter and more amenable to pedestrian crossing.
