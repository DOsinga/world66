...
Tours begin with a trolley ride down into a sinkhole, then continue on foot through lit chambers decorated with stalactites, stalagmites, and cave formations. The main cave — Cueva Clara — is enormous, its ceiling lost in darkness above. The park is well managed and the guided tours are informative, though it can get crowded on weekends. Go on a weekday morning if you can, and check that the park is open before you make the trip — it closes periodically after heavy rain.
