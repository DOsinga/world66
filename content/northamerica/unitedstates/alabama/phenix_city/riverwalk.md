...
latitude: 32.4710
longitude: -85.0005
snippet: Paved path along the Chattahoochee linking Phenix City and Columbus
tags:
- things_to_do
- sight
- park
...
The Phenix City side is generally quieter and shadier than the Columbus side, and the views across to the Columbus skyline are best from the west bank. Cyclists and joggers from both cities use it constantly. Pick up the trail at the Idle Hour Park parking lot for an easy starting point.
