...
The outdoor village is the highlight — full-size reconstructions of dwellings from each region, with Alaska Native interpreters on hand to explain how they were built and used. The lake-side path links them all. Open daily in summer; reduced hours October to mid-May.
