...
- things_to_do
- sight
title: White Pass and Yukon Route Railroad
type: poi
story: >
  The railway was built in 1898 in just 26 months through terrain so formidable that
  engineers from other projects said it couldn't be done. At the summit the line crosses
...
Excursions run from spring to autumn when the cruise ships are in port. The most popular option is the summit return trip; longer journeys into the Yukon Territory are also available. The vintage rail cars and the engineering feat of the route itself make this one of Skagway's unmissable experiences, whether or not you have any particular interest in railway history.
