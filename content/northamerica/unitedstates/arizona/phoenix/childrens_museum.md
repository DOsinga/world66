...
latitude: 33.4513
longitude: -112.0653
snippet: Three-storey hands-on museum for kids in the historic Monroe School
tags:
- things_to_do
- museum
- downtown_phoenix
...
Other exhibits include a noodle forest, a giant racetrack for hand-pushed cars, an art studio that runs structured drop-in projects, and a child-sized supermarket. The museum closes for several hours mid-week for cleaning, so check hours before showing up. Parking is in the lot directly east of the building, with the first hour validated free.
