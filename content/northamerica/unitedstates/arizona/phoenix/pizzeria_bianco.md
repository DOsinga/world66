...
latitude: 33.4509
longitude: -112.0666
snippet: James Beard-winning wood-fired pizzeria in Heritage Square
tags:
- eating_out
- restaurant
- downtown_phoenix
...
The original location is a small brick building in Heritage Square, with limited tables and famously long waits. Reservations now open online a month out for the first slot of the night; later in the evening is walk-in only. There's a larger Bianco location further north on Camelback Road if downtown is full. The bread, made in-house, is reason enough to come on its own.
