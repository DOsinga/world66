...
latitude: 38.8000
longitude: -120.8940
snippet: "The state park preserving the exact spot where the California Gold Rush began"
tags:
- things_to_do
- sight
- museum
...
You can pan for gold (small fee for equipment), watch blacksmith demonstrations, and walk the river trails. The visitor center has the orientation film. Plan on three to four hours for a full visit; less if you skip the museum. Open daily, parking fee applies.
