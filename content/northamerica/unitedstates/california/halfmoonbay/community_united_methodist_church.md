...
latitude: 37.4628
longitude: -122.4269
snippet: 1872 wooden gothic-revival church, the oldest Protestant church building on the San Mateo coast
tags:
- things_to_do
- sight
- architecture
...
The church is still an active congregation, so the interior is generally only open during services. Even passing by on the way to or from Main Street is worthwhile: it is one of the few buildings in central Half Moon Bay that has changed very little since the town's farming-and-shipping days, when the schooner trade out of Pillar Point was the main link to San Francisco.
