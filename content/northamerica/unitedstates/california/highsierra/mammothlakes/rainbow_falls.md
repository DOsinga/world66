...
title: Rainbow Falls
type: poi
tags: [things_to_do, sight, waterfall, hike]
latitude: 37.6108
longitude: -119.0799
...
The trailhead is accessed by shuttle from the Mammoth Mountain Inn during peak summer season, and the hike from the shuttle stop to the falls is around two miles each way on a well-maintained trail. It can also be combined with a visit to Devil's Postpile National Monument, which lies along the same trail corridor. The canyon walls make the falls feel enclosed and dramatic rather than simply tall, and the viewpoints — at the rim and at the base, reached by a steep side trail — offer very different perspectives.
