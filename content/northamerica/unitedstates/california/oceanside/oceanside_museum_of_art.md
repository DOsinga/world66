...
The museum rotates its exhibitions regularly and has a permanent collection with regional strengths. Admission is reasonable, and the downtown location makes it easy to combine with a walk to the pier or a meal on the harbourfront. OMA also manages the Top Gun House on Mission Avenue, using it for community events.
