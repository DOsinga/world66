---
title: "International Surfing Museum"
type: poi
tags:
  - things_to_do
  - museum
  - downtown
snippet: "Surf culture archive a block from the pier"
...
Admission is by donation. Two hours is more than enough; allow an hour if you are not already a surf-history nerd. The museum also runs the **Surfing Walk of Fame** plaques set into the sidewalk at Main and PCH outside, and the **Surfers' Hall of Fame** handprints in concrete in front of Huntington Surf and Sport across the street.
