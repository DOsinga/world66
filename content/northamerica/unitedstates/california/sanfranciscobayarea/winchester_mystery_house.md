...
latitude: 37.3184
longitude: -121.9511
snippet: A famously eccentric San Jose mansion of staircases, sealed doors, and Victorian
  unease.
story: 'Sarah Winchester''s house became legendary for its oddities: stairs that climb
  into ceilings, doors that open onto drops, and a building campaign said to have
  continued for decades. The ghost story is louder than the evidence, but the house
  is strange enough without embellishment.'
tags:
- things_to_do
- architecture
- sight
