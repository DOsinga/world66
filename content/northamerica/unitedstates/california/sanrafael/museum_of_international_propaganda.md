---
title: Museum of International Propaganda
type: poi
tags:
  - things_to_do
  - museum
...
The collection avoids making easy political arguments and lets the material speak for itself, which makes it more thought-provoking than a museum with a simpler thesis might be. It is small and can be done in an hour or so, but the quality of the collection is exceptional. Free admission makes it an easy addition to a San Rafael day.
