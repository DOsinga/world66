...
The hotel is still operating and still private — the bar and restaurant are notionally open to the public but in practice require knowing someone or looking the right way. Worth seeing from outside in any case: the drive up the steep approach gives the best view of the facade, and the billboard across Sunset is always one of the most watched on the Strip.
