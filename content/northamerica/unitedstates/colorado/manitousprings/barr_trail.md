...
longitude: -104.9282
story: >
  Fred Barr built this trail by hand between 1914 and 1921, working largely alone and
  using dynamite where the rock was too hard to dig. He charged a toll for the first
  several decades and lived in a stone cabin at the halfway point, still standing today
  as Barr Camp. The Pikes Peak Marathon, which sends runners up and back on the same
