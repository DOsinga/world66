...
The setting is rough — a wood-frame building with screens for windows and an outdoor deck over the inlet — and the wait can be long on weekends. Worth it for the soft-shell. Closed Mondays.
