...
The Ice Plant fills up fast on weekends, especially in season. Getting there before 6pm saves a wait. The adjacent St. Augustine Distillery makes gin, vodka, rum and bourbon from Florida grain and sugarcane; distillery tours run on weekdays and are free, with tastings. The whole operation is well run and the combination of bar, restaurant, and working distillery makes it the most interesting stop in town after the historic sites.
