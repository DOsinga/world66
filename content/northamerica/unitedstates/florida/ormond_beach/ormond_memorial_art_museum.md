---
title: "Ormond Memorial Art Museum and Gardens"
type: poi
tags:
  - things_to_do
  - museum
...
Admission is free, and the museum is open daily except Saturdays. The galleries change with rotating exhibitions alongside the permanent collection. The gardens are the main draw for casual visitors: fig trees, bamboo groves, flowering shrubs, and several mature specimen trees create a quiet enclave in the middle of a busy commercial street. The museum runs family art events on Friday evenings that are popular with local families and a good way to see the building in use.
