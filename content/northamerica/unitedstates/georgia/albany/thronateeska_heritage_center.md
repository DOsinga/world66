...
"Thronateeska" is the Creek name for the Flint River, meaning "place where flint was picked up." The center is a serious institution, founded from a merger of the Southwest Georgia Historical Society and the Albany Junior Museum, and it punches well above the weight you'd expect from a city this size. The railway history section is particularly strong, reflecting Albany's importance as a rail hub.
