...
The single test firing proved the concept spectacularly wrong. The balls came out of the barrels at different speeds, the chain pulled them into a zigzagging arc, and the resulting path of destruction was entirely random. No further tests were conducted. The cannon was presented to the City of Athens, which has kept it on display ever since, pointed north in the general direction of the old enemy.
