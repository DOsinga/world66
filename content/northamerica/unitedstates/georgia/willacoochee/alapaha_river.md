...
Canoe and kayak access points are few and not always well marked, but the river is navigable in a small craft. The surrounding bottomland forest of cypress, tupelo, and water oak is worth seeing in its own right — especially in early spring when the cypress is putting out new needles. Local knowledge helps; ask at the hardware store or gas station about current conditions and access.
