...
The area is best for dinner rather than lunch, when the working day brings restaurant capacity in the Loop and River North together. The cocktail bar scene is also concentrated here — GMan Tavern, Boka, and a rotating cast of hotel bars operate within a few blocks. The neighbourhood's proximity to the Magnificent Mile means tourist overflow, but the better restaurants are used by Chicago residents rather than visitors.