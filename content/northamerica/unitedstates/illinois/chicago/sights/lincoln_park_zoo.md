...
ADMISSION IS FREE.
Events are offered year round with a huge range of interests and age targets. There are also seven restaurants and three places to shop. The animal exhibits include Birds, Tropical Birds, African Large Mammals (i.e. Giraffes, Rhinos), Large Cats, Forest Animals (i.e. Bears, Otters), Reptiles, Fowl, Primates, Arctic Animals (Polar Bears, Penguins, Seabirds), and the animals down at the farm.

**To get there by car**: exit Lake Shore Drive at the Fullerton Parkway exit, north of the loop. From I-94, exit at either Fullerton Parkway or North Avenue and go east.

**By bus:** CTA bus routes 151 or 156 will get you there, the 151 comes from Union Train station.
