...
The IMAX theatre on site (the largest screen in Indiana) often runs alongside special exhibitions. Plan two to three hours for the permanent collection. The building itself is worth a look — it uses 92 different Indiana materials, one for each county.
