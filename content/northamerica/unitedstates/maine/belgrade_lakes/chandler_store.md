...
type: poi
snippet: 19th-century general store in the village centre
tags:
  - things_to_do
  - sight
  - historic_landmark
...
It now houses small shops and is open for browsing during the summer season. Even from outside, the building is the most photographed thing in the village: long, two-storey, painted white with green shutters, set back behind a stretch of grass beside the channel between Great Pond and Long Pond. A useful first stop on a walk through the village.
