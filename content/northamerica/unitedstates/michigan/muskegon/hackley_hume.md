---
title: Hackley and Hume Historic Site
type: poi
tags:
  - things_to_do
  - museum
...
Guided tours run through both houses and explain the lumber industry that built them, Hackley's remarkable philanthropy (he gave the city its library, park, hospital, and several schools), and the social life of a Gilded Age Michigan boomtown. The exterior Queen Anne facades, with their towers, porches, and decorative shingles, are among the most visually striking examples of that style in the Midwest.
