---
title: Ely's Peak and DWP Railroad Tunnel
type: poi
tags:
  - things_to_do
  - sight
...
The trail passes through the abandoned DWP Railroad Tunnel, a low and dark passage through the basalt ridge that adds considerable atmosphere to what would otherwise be a standard forest hike. The tunnel is part of the Willard Munger State Trail network, which extends many kilometres along the valley and is popular with mountain bikers and cyclists. The trailhead is accessible from the Jay Cooke State Park area or from Fond du Lac.
