...
The self-guided tour takes about an hour and is genuinely engaging for anyone with any interest in maritime history, engineering, or the Iron Range ore economy that shaped the upper Midwest. In October the ship runs popular "Haunted Ship" events that have a devoted following — if you are visiting in autumn, booking in advance is advisable.
