...
Bothwell left the estate to the state of Missouri on his death in 1929 with instructions that it be used as a park. It is now run as a State Historic Site with guided tours of the house, walking trails across the 180-acre grounds, and access to the cave entrance. Tours run Wednesday to Sunday; the trails are open year-round.
