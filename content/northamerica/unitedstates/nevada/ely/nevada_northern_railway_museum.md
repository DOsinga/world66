...
latitude: 39.2459
longitude: -114.8736
snippet: A perfectly preserved 1970s copper-mine rail yard, open to visitors
tags:
- things_to_do
- museum
- railroad
...
The machine shop, the depot, and the roundhouse are all intact. Steam locomotives run weekend excursion trips along the original ore line, with special events including the Ghost Train around Halloween. Allow at least two hours; the yard is larger than it looks from the entrance.
