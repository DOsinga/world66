...
type: poi
address: 1218 South Main Street
latitude: 36.1565
longitude: -115.1537
snippet: "Female-owned cocktail bar anchoring the Arts District"
tags:
- bars_and_cafes
- bar
- arts_district
...
The patio out back is one of the best outdoor drinking spaces in the city — string lights, mismatched seats, and live jazz some nights. The bar runs a low-key live music programme indoors and hosts the occasional poetry reading. Beer and wine lists are well chosen but cocktails are the reason to come. A short rideshare from downtown or central Strip.
