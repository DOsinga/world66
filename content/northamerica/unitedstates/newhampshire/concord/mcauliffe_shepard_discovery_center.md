...
longitude: -71.5325
story: >
  Christa McAuliffe, a Concord High School social studies teacher, was selected from over 11,000
...
For families this is an easy half-day. The hands-on exhibits — orbital mechanics, scale-model rockets, an Apollo command module mock-up — work well for kids of mixed ages, and the staff astronomers are happy to talk at length. The replica Redstone rocket out front, modelled on the one that lifted Shepard into space, is hard to miss from the parkway and is a popular photo stop.
