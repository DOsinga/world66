...
The churchyard is open and worth a slow walk. The old headstones carry the familiar colonial-era imagery — hourglasses, winged skulls, weeping willows — and the inscriptions give the town a human scale that the battlefield markers and historical plaques can't quite provide. St. Peter's is still an active congregation, so the building itself is not always open to visitors, but the exterior and grounds are accessible at any time.
