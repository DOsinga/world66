...
longitude: -105.2733
sources:
  - https://en.wikipedia.org/wiki/Angel_Fire_Resort
story: >
  Angel Fire contains the only half-pipe for snowboarders in the state of New Mexico, 
...
Winter is the obvious season, but Angel Fire runs all summer as a mountain bike park. Lift-served downhill trails draw riders from across the Southwest, and rental equipment is available at the base. The resort also hosts trail running events and mountain-top zip lines when the snow is gone.
