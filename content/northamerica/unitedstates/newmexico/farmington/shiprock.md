...
longitude: -108.8347
story: >
  To the Navajo, Shiprock — Tsé Bit'a'í, "rock with wings" — is a sacred site
  with deep spiritual significance. The geological reality matches the mythology:
  it is the eroded core of an ancient volcano, the magma solidified and the
...
The best views are from the road approaching from the east, where the full height and isolation of the formation is most apparent. The nearby town of Shiprock has services. There's no formal visitor facility, but the BLM land around the base allows access for walking.
