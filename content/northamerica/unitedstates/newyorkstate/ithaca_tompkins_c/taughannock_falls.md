...
type: poi
snippet: "215-foot waterfall, taller than Niagara, just up the lake"
tags:
  - things_to_do
  - sight
  - park
...
Spring melt and after heavy rain are when the falls are at full force; in late summer the flow can drop to a thin ribbon. The park has a small beach on Cayuga Lake and is one of the easier ways to combine waterfall and swim.
