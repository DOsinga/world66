...
For visitors with a day to spare, the loop south from Asheville via the parkway, Sliding Rock, Looking Glass Falls, and Brevard takes in a string of classic stops. Mountain bikers head for the Pisgah Ranger District's trail network, climbers for Looking Glass Rock, and trout fishers for the cold streams below the waterfalls.
