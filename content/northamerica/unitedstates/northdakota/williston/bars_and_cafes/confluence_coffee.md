...
On winter mornings it fills with the particular mixture of people that small northern cities generate: contractors waiting for conditions to improve, students doing coursework, retirees with no pressing reason to be anywhere else. The coffee holds up against whatever the weather is doing outside, which in this climate is no small thing.

Hours are typically early morning through mid-afternoon on weekdays, with slightly shorter hours on weekends. Located in central Williston.
