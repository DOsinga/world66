...
latitude: 36.6800
longitude: -101.4800
snippet: Possibly the longest straight road in the United States passes through Guymon
tags:
- things_to_do
- road_trip
title: U.S. Route 412
...
The road is the eastern half of an old transcontinental route, and the small towns along it — Hooker, Adams, Tyrone — have a particular kind of survivor character: dwindling populations, surviving grain co-ops, a single open diner. Going west from Guymon, 412 connects to the New Mexico high plains and eventually to the Sangre de Cristos. Going east, it eventually carries you to Tulsa, then to Memphis. Either direction is a long drive worth taking once.
