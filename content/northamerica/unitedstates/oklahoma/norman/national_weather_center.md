...
Free public tours run on weekday afternoons (reservation required) and take in the forecasting room, the radar operations centre, and an observation deck with one of the best views in central Oklahoma. The on-site Storm Chase exhibit covers the history of tornado research in the southern Plains. Particularly worthwhile in spring tornado season when the building is at its busiest.
