---
title: Cordell Carnegie Public Library
type: poi
...
The Cordell Carnegie library is still in use as the town's public library, which puts it in good company — many Carnegie buildings across Oklahoma were repurposed or demolished, and the ones still functioning as libraries are increasingly rare. If you are passing through, it is the kind of small-town building that rewards a brief stop: the architecture is honest, the scale is human, and the fact that it has been continuously serving its original purpose for well over a century is worth noting.
