...
Getting there without a car requires either a bus (line 51 to the nearest stop, then a walk) or a moderately strenuous hike up from the Marquam Hill area using the Marquam Trail, which links to the Wildwood Trail in Forest Park. The park itself is small and takes only 20 minutes to walk around. Best visited in the evening when the light catches the volcanic peaks.
