...
Tours depart from the Hobo's Restaurant on SW 3rd Avenue and run on weekend evenings. They're two hours, require advance booking, and include a visit to the actual tunnels plus the adjacent areas. The guides are performance-oriented — the atmosphere is more theatrical than academic — but the history is broadly accurate and the physical space is genuinely interesting. Not suitable for those with mobility issues or severe claustrophobia.
