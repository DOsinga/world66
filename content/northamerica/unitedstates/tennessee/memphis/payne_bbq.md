---
title: "Payne's Bar-B-Q"
type: poi
latitude: 35.1484
longitude: -90.0285
snippet: Cash-only Memphis institution; the chopped pork shoulder sandwich is the only reason you need
tags:
  - eating_out
  - restaurant
  - barbecue
...
Payne's has been here since the 1970s, operated by the same family, using the same methods. It is emphatically a local institution rather than a tourist destination — the clientele is overwhelmingly people from the surrounding neighborhoods who have been coming here for years. That is, in itself, a recommendation. Go for lunch; it sometimes closes early when the meat runs out.
