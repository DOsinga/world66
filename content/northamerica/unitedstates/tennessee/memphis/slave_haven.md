---
title: "Slave Haven Underground Railroad Museum"
type: poi
latitude: 35.1527
longitude: -90.0513
snippet: Museum in a pre-Civil War house with documented Underground Railroad history
tags:
  - things_to_do
  - downtown
  - museum
...
The exhibits are relatively small but the subject is handled with seriousness and the specific Memphis and Mississippi Delta context is well-explained. Memphis, as a major river city close to the slave states of Mississippi and Arkansas, occupied a particular position in both the plantation economy and the resistance to it. The museum makes that position clear. It is a short distance from the Victorian Village district and can be combined with a visit there.
