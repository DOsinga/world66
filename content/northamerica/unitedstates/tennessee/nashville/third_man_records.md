...
Behind a glass wall, you can watch the Third Man Pressing plant — a fully working vinyl pressing facility — running on the same machines that have been making LPs since the 1970s. The Voice-O-Graph booth, where visitors can record a song to acetate, is a one-of-a-kind experience. Open hours are limited, so check the schedule before going.
