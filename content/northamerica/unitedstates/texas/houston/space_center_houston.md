...
latitude: 29.5519
longitude: -95.0983
snippet: NASA's official visitor complex — the most complete space museum in the country
tags:
- things_to_do
- museum
...
type: poi
story: >
  The Mission Control room displayed at Space Center Houston is the actual room used
...
The NASA tram tour is the highlight — it takes you through the actual JSC campus, including the current Mission Control operations centre, the astronaut training facility, and (on many days) the Neutral Buoyancy Laboratory where astronauts train underwater in a full-scale replica of the ISS. Allow a full day. The centre is 45 minutes from downtown by car; the drive is not scenic, but it is worth it.
