...
The 1st Cavalry Division Museum and the III Armored Corps Museum are both open to the public (with base access) and are worth the effort. The collections cover US armored and air assault operations from World War II through Iraq and Afghanistan, with a strong emphasis on personal accounts and equipment rather than abstract history. Access requires a valid ID; foreign nationals should check current base visitor procedures before visiting.
