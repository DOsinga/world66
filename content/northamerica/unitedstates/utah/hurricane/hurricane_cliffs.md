...
At sunset the sandstone turns a deep orange-red that is worth timing deliberately. Hiking trails run along the base of the cliffs and on the mesa above; some are accessible directly from town and some require a short drive west. The cliffs are also visible from most of Hurricane, so even if you don't make it out to walk them, they serve as a constant reminder that you are in serious geological country.
