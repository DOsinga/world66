---
title: "Burlington Waterfront and Bike Path"
type: poi
...
The paved Bike Path follows the waterfront for eight miles and connects to a larger trail network that eventually reaches Colchester to the north. Bikes can be rented from several shops near the waterfront and from the shared bike-share stations. In summer the path gets busy with cyclists, joggers, and rollerbladers; early morning is the best time for a peaceful ride. Winter brings ice on the lake and a different kind of beauty — clear cold days when the Adirondacks are dusted with snow.
