...
The park is also the trailhead for several routes into the Green Mountain backcountry, and the Appalachian Trail passes right through it — one of the few places in Vermont where you can walk to an AT trailhead without a car. In autumn, the old-growth maples turn a deep crimson that is a different colour from the surrounding trees; it is among the best foliage viewing in the state.
