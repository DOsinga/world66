...
This is a local park used mostly by nearby residents, and it functions well as one. It's not a destination worth a dedicated trip from Washington, but if you're spending time at the Udvar-Hazy Center and want somewhere quiet afterward, the park is a reasonable place to walk for an hour. The creek corridors hold good bird habitat in spring migration, which draws birders from across the region.
