...
The church is open to visitors for self-guided tours when not in use for services. The interior contains the original governor's pew, where royal governors sat in elevated state, as well as the chancel, organ, and box pews that give a direct sense of 18th-century colonial worship practice. The graveyard beside the church contains notable colonial-era burials. The building managed to survive both wars and the various fires that destroyed other colonial structures, and its continuous history as a congregation makes it different in character from the reconstructed buildings around it.
