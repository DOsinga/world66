...
- museum
- history
title: Wahkiakum County Historical Museum
type: poi
---
...
Wahkiakum County has never had a highway bridge across the Columbia — the only crossing into Oregon is the county ferry — so the museum also captures a sense of the insular, self-reliant character that geography imposed on the community. It's a small museum in a small town, but it tells a story you won't find told anywhere else.