---
title: Port Gamble Historic District
type: poi
latitude: 47.8553
longitude: -122.5828
tags:
...
The whole place takes an hour to walk, less if you do not stop. The General Store sells decent sandwiches and ice cream; the second floor has a small but oddly enthralling shell museum, with one of the largest private shell collections in the world. Port Gamble is on the way to or from the Kingston ferry and to the Olympic Peninsula, which makes it an easy add-on rather than a destination.
