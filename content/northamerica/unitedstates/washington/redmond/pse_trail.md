...
The trail connects to the Bridle Crest Trail and eventually to the larger trail network that extends into the east Kirkland hills. Mountain bikers use the trail regularly, and the unpaved sections in wet weather add challenge. For visitors without bikes, it's a good option when the main Sammamish trail feels crowded — the PSE Trail carries far less traffic and has a quieter atmosphere.
