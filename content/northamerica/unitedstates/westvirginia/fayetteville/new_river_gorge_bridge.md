...
type: poi
snippet: One of the longest steel arch bridges in the world, 267m above the river.
tags:
  - things_to_do
  - sight
  - architecture
...
For a more visceral encounter, the privately run **Bridge Walk** takes small groups (in harnesses, on a permanent catwalk underneath the highway deck) the full length of the bridge — a serious bucket-list experience for anyone comfortable with heights.
