...
type: poi
snippet: Some of the best big-water rafting in the eastern US, on two rivers.
tags:
  - things_to_do
  - sight
latitude: 38.0560
...
The **Gauley River**, 30 minutes north, is the harder, more famous run — Class IV–V whitewater that opens only for six weekends each autumn when the Summersville Dam releases water. Outfitters in town (ACE Adventure, Adventures on the Gorge, New & Gauley) run trips from a half-day to multi-day camping packages. April to October is the main season.
