---
title: "Trappers Point"
type: poi
tags: [things_to_do, sight]
snippet: Ancient pronghorn migration bottleneck and archaeological site
latitude: 42.8761
longitude: -109.9458
story: >
...
The site is also one of the best places in Wyoming to witness the pronghorn migration itself. Pronghorn move through in large numbers twice a year — north in spring and south in autumn — and the passage through Trappers Point concentrates them into a visible flow. The migration is one of the longest land animal migrations in the Western Hemisphere, rivalling the Serengeti wildebeest in its scale relative to the landscape.
