---
title: "Periodic Spring (Intermittent Spring)"
type: poi
latitude: 42.7444
longitude: -110.8485
tags:
...
Getting there involves a pleasant 2 km walk up Swift Creek Canyon along a well-marked trail through tall cottonwoods and willows. The canyon itself is scenic enough to justify the trip even if the spring happens to be in its off-season (May through July, when snowmelt keeps the aquifer full and the siphon never fully empties, the spring runs continuously rather than intermittently). From Afton, take the road east up Swift Creek — the trailhead is clearly signed.
