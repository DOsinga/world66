---
title: "La Bombonera (Estadio Alberto J. Armando)"
type: poi
tags:
  - things_to_do
  - laboca
...
Attending a match requires planning: tickets for big games sell out weeks in advance, and the stadium is divided into strict sections (home, away, and a separate section for visiting neutrals). Stadium tours run on non-match days and include the pitch, the changing rooms, and the Museo de la Pasión Boquense in the stadium base, which documents the club's history in the kind of detail that only true devotion can sustain.
