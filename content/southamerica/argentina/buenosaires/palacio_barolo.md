...
The facade combines Gothic, Baroque, and Indo-Saracenic elements in an idiosyncratic way that somehow works. Rooftop tours run in the evenings (book through the building's website) and on a clear night the lighthouse at the summit illuminates and can be seen for miles — on the nights it operates, the symmetrically designed Palacio Salvo in Montevideo, across the Río de la Plata, flashes back. The two buildings were designed by the same architect.
