...
The classic stops are the **Punto Panoramico** viewpoint, the **Capilla San Eduardo** wooden chapel near Llao Llao, the **Bahia López** trailhead at the foot of Cerro López, and the **Colonia Suiza** village. Buses follow most of the route, so it can also be done as a hop-on-hop-off day with local transport.
