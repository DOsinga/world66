...
latitude: -16.5089
longitude: -68.1170
snippet: Sopocachi's most reliable bar for craft beer and a mixed local-and-traveller crowd.
tags:
- bars_and_cafes
- bar
...
The altitude note applies here more than most places: Sopocachi sits around 3,600 metres, and two or three beers will leave you more affected than you expect. Diesel Nacional is not a late-night place by the standards of most cities — things get going around nine, peak around eleven, and are largely done by one. There are louder and later options in the neighbourhood, but Diesel Nacional is where you go when you want to have a conversation and hear what the person next to you is saying.
