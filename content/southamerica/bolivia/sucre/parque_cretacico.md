...
The on-site museum runs continuous video presentations on the discovery of the tracks and the geology of the area. Guided tours (extra fee) lead small groups down to the foot of the cliff for a much closer look at the prints than the viewing terrace allows. The Dino Bus from the cathedral runs twice daily, includes transport and entry, and saves a taxi ride. Plan two hours minimum, longer if you have kids.
