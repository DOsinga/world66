...
latitude: -21.6138
longitude: -64.7432
snippet: Bolivia's wine-producing heartland, 15 km south of the city
tags:
- things_to_do
- sight
- wine
title: Valle de la Concepción
type: poi
story: >
...
Both major wineries offer tours and tastings. Concepción (Casa Real) is the larger and more commercial operation; Kohlberg is smaller and the wine is generally considered more refined. A third-wave of smaller producers is emerging, some of them working with traditional Criolla grapes that predate the modern wine industry. The setting — terraced vineyards below red sandstone cliffs — is as appealing as the wine itself. You can reach the valley by taxi from Tarija in about 20 minutes, or by a local bus that runs several times daily.
