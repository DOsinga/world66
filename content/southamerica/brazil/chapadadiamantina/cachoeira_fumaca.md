---
title: Cachoeira da Fumaça (Smoke Falls)
type: poi
tags:
  - things_to_do
  - sight
...
An alternative approach goes from below, from the village of Yale in the Capão Valley, following the river canyon upstream to the pool at the base. This approach is longer (around 4 hours each way) but gives a completely different perspective — the full height of the cliff above, the mist and thunder of the falls, and the lush canyon vegetation. Both approaches require a licensed guide. The two can be combined as a two-day trip with camping, approaching from above on the first day and descending to the base on the second.
