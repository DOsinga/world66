...
The trails from Capão include the approach to Cachoeira da Fumaça from below and several longer routes into the park's interior. The valley itself is lush and fertile by Chapada standards, with a year-round stream and good conditions for growing fruit and vegetables that supply the village restaurants. The community here has a more alternative, laid-back character than Lençóis, and some travellers prefer it as a base for exactly that reason.
