...
latitude: -30.0329
longitude: -51.2302
snippet: The grand civic square at the heart of Porto Alegre's colonial centre
tags:
- things_to_do
- sight
...
Sitting on a bench here in the late afternoon — when the golden light falls on the cathedral's twin towers and the office workers cross the square on their way to the Trensurb — gives you a good feel for the city's particular character: proud of its European heritage, a little formal, but not unfriendly. The square is also the traditional starting point for walking the Centro Histórico; from here you can reach the Mercado Público, the MARGS, and the waterfront all within ten minutes on foot. There is a small café kiosk in the square that does reasonable espresso.
