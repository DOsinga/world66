---
title: Museu do Amanhã (Museum of Tomorrow)
type: poi
snippet: Santiago Calatrava's futuristic science museum on the revamped Porto Maravilha waterfront
tags:
  - things_to_do
  - museum
  - architecture
...
Inside, the permanent collection explores five major questions about the future — Cosmos, Earth, Anthropocene, Tomorrow, Us — through large-format interactive displays, projections, and immersive environments. The museum pitched itself at families and school groups but the content is rigorous enough for adults. The surrounding Porto Maravilha district has been transformed from a derelict port zone: the VLT tram connects it to Praça XV and Central do Brasil station. Combine with the nearby Museu de Arte do Rio (MAR) on the same waterfront.
