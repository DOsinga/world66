...
longitude: -46.6346
score: 8.0
snippet: São Paulo's classic art-deco skyscraper, with an observation deck on the
  35th floor
tags:
- things_to_do
- sight
...
The building was converted into a cultural centre in 2018 and now holds rotating exhibitions, a permanent display of the bank's vault, and a few cafes. Combine the visit with the surrounding centro sights — Theatro Municipal, Mosteiro de São Bento, and the Edifício Martinelli are all in walking distance.
