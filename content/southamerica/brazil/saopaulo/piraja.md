...
longitude: -46.6925
score: 6.8
snippet: Classic Pinheiros boteco — chopp, croquetes, and crowds spilling onto the
  sidewalk
tags:
- bars_and_cafes
- bar
...
A good first stop on a Pinheiros-into-Vila Madalena night. The sister bar Original in Pinheiros and Astor across town in Vila Madalena are similar in spirit, all run by the same group. None of them take reservations and none of them are quiet; that is the point.
