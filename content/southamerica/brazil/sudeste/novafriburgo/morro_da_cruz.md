...
longitude: -42.5347
story: >
  The cross on the summit has stood in various forms since the Portuguese
  colonial period, when hilltops were crowned with crosses to mark Christian
  territory and serve as landmarks for travellers in the forested serra.
...
The cable car is the easiest option for the view, but it is also worth walking up on one of the several trails that start from the edges of the city — the ascent takes around an hour and the forest cover on the slopes holds birds, butterflies, and the cooler air that Nova Friburgo's altitude provides. The summit area has a bar and food stalls on weekends.
