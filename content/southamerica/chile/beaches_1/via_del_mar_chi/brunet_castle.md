---
title: "Brunet Castle (Palacio Yarur)"
type: poi
tags:
  - things_to_do
  - sight
...
It sits close to the water's edge, visible from the bridges crossing the estuary, and is best appreciated from the street or the riverbank. The building has changed ownership several times and its current use is primarily cultural; check locally for any exhibitions or events being hosted when you visit.
