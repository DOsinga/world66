...
It was built using profits from the saltpetre trade and meant to bring European high culture to a frontier port. Performances still take place — visiting opera, dance, and classical concerts — but if there is nothing on, the box office staff will usually let visitors peek inside during the day.
