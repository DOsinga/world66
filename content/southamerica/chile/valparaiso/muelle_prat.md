---
title: Muelle Prat and Harbour Tours
type: poi
latitude: -33.0362
longitude: -71.6302
tags:
...
The harbour tours run throughout the day when there are enough passengers; the cost is very low. The boats pass close to container ships, cruise vessels, and occasionally naval ships from the Chilean Navy's base here. The view back toward the hills from the water, with the funiculars climbing the slopes and the murals visible on the house facades, is one of the classic perspectives of Valparaíso. Boats also run across to Viña del Mar's port area.
