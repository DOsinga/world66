...
The square is the starting point for most walks in central Valparaíso. It connects to Muelle Prat, where boat tours of the harbour depart, and the Ascensor Artillería, which rises to the Naval Museum. The view from the square toward the container port gives a vivid sense of Valparaíso as a working industrial harbour rather than simply a heritage tourism site.
