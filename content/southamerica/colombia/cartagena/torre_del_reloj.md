...
latitude: 10.4218
longitude: -75.5472
snippet: Clock tower gate, the main entrance to the walled city
tags:
- things_to_do
- landmark
...
Most visitors pass through it multiple times a day as it sits at the junction between the old city and the main taxi and bus routes. It's more impressive seen from outside looking in — the view from Plaza de la Aduana toward the tower, with the city walls stretching away on each side, is one of the classic images of Cartagena.
