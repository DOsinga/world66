---
title: Cayambe-Coca Ecological Reserve
type: poi
tags:
  - things_to_do
  - sight
...
Access from Cayambe is via the same dirt road used for volcano climbs, which climbs through onion fields and open páramo before reaching the glacial margins. Day hikes through the high páramo — the spongy, windswept grassland that covers the Andean highlands — are feasible without mountaineering equipment. The trailhead near the Ruminahui refuge has short walks with views across the reserve.
