...
The resort has two distinct sections: the public **Balneario**, where day visitors pay a modest entry fee and share the main pools, and the more upscale **Spa** section with private pools, massage treatments and better facilities. The hotel cabañas are comfortable if slightly overpriced. Weekends in Quito-holiday season fill the public pools to capacity — go early in the morning or on a weekday if you want to soak in peace. The setting is beautiful: pool edges run to the tree line, mist often drifts in from the forest, and on clear mornings you can see Antisana.
