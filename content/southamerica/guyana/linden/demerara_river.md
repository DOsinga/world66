...
The old colonial-era pontoon bridge across the river, which connects the two parts of the town (Mackenzie on the west bank and Wismar on the east), was a landmark of Linden for decades, though it has been replaced. Swimming in the river is popular with locals at certain points, though the current can be strong.
