...
The cathedral is free to enter and is usually open during daylight hours. The plaza in front is Asuncion's main gathering point, used for everything from political rallies to food festivals, and the benches under the trees are reliably occupied by locals passing the time. The surrounding streets — particularly Calle Palma — are the closest thing Asuncion has to a pedestrian shopping district.
