...
The above-ground structures include a sunken square, stone-faced terraced platforms, and carved stone heads (cabezas clavas) that once protruded from the temple walls. The underground galleries are the real draw — a remarkable engineering achievement in which precisely cut stone blocks form a network of corridors and chambers that have survived multiple earthquakes. The on-site museum displays the carved Tello Obelisk and other finds. The drive from Huaraz via the Kahuish tunnel takes about 3 hours.
