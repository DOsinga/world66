---
address: Pasaje Leoncio Prado 122, Yanahuara, Arequipa
latitude: -16.3853
longitude: -71.5407
snippet: Long-running picantería with a wood-fired clay oven and a rambling patio
tags:
- eating_out
- restaurant
- peruvian
...
The *chactado* (flattened, deep-fried guinea pig) is a specialty if you want to try cuy in its most authentic form. The shrimp dishes, when the river prawns are in season, are the other reliable choices. The chicha de jora and chicha morada are made on site. Lunch only; busy on weekends.
