...
longitude: -71.9764
story: >
  Inca stonemasons worked without mortar and without metal tools — only harder stones and bronze
  implements. They shaped each block to fit its neighbours precisely, using a technique of
...
The stone is part of the original Inca wall of the Roca palace, incorporated into the Spanish colonial building above it. You'll find it by following the crowd — a photographer usually marks the spot — or by counting the angles yourself once you're close enough to see the individual faces. The whole street has well-preserved Inca stonework worth examining, but the twelve-angled stone is the showpiece.
