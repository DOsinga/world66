...
Between buggy runs, you stop at the top of dunes to try sandboarding. You can go standing up (harder than it looks) or lying down on the board headfirst (faster, easier, sandier). The tours run about two hours and are timed to finish around sunset, which is worth it for the light alone.
