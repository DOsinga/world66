---
title: Kotosh (Temple of the Crossed Hands)
type: poi
tags:
  - things_to_do
  - sight
...
The visible ruins are modest in scale compared to more famous Peruvian sites, and the original crossed-hands relief was removed to the Museo Nacional de Antropología in Lima for preservation (a replica sits in its place). But the site retains enormous historical resonance, and the setting — terraced hillside, mountain views, quiet atmosphere — makes the visit worthwhile. A small site museum explains the different cultural periods and houses some recovered artifacts. Getting there is easy by taxi from the city centre (around 15-20 minutes). Opening hours are roughly 8am-5pm; check locally as they vary.
