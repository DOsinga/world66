...
Most trekkers do it anticlockwise, starting from Cashapampa and finishing at Vaqueria, or vice versa. The trail is well-marked and can be done without a guide, though an arriero (mule driver) is useful for carrying equipment and knowing the route in poor weather. Allow four days for a comfortable pace; fit trekkers sometimes compress it into three. Altitude acclimatisation in Huaraz for at least two days before starting is essential — the pass at Punta Union is no joke for anyone arriving fresh from sea level.
