...
There are daily flights from Lima and Cusco to Puerto Maldonado that is why this is an excellent option to combine an archaeological trip with the rainforest. There are different companies offering services tour packages. Without doubt the most reliable tour operators are Inkanatura Travel that manages Sandoval Lake Lodge, Rainforest Expeditions that operates Posada Amazonas or Inkaterra that manages Reserva Amazonica. 
