# Wikitravel Coverage Task

Fill gaps in World66 coverage identified by comparing against Wikitravel's featured
destinations. These are destinations that Wikitravel prominently links from country pages —
regions, islands, national parks, scenic areas, and notable cities — but that World66 either
lacks entirely or has very thin coverage of.
...
4. **Decide the POI target** for this destination:
   - Major Wikitravel-featured city or region (e.g. Gyeongju, Torres del Paine): **at least 25 POIs**
   - Scenic region or island (e.g. Svaneti, Taroko Gorge, Sognefjorden): **15–25 POIs**
   - Natural site or park (e.g. Etosha, Bwindi, Murchison Falls): **10–15 POIs**
...
12. **Commit** as `Wikitravel coverage: Destination Name` — one commit per location.
...
- [ ] `done: { wikitravel_coverage: <today> }` set on the main location file
