...
from train_scoring_model import build_model

PROJECT_DIR = Path(__file__).resolve().parent.parent
SCORING_DIR = PROJECT_DIR / "scoring"
EMBEDDINGS_FILE = SCORING_DIR / "all_location_embeddings_large.npz"
MODEL_FILE = SCORING_DIR / "production" / "deep_128_32_hidden_12.pt"
OUT_FILE = SCORING_DIR / "all_location_dimensions.json"
HIDDEN_OUT = SCORING_DIR / "all_location_hidden_12.npz"
