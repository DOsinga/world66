...
from plans_app.views import api_plan_create, api_plan_add_pois, api_research_submit, api_link_preview, api_harvest_pois
...
urlpatterns = [
    ...
    path("api/plans/harvest-pois/", api_harvest_pois, name="api_harvest_pois"),
